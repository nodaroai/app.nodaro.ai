...
const VIDEO_MODELS: Record<string, ModelCatalogEntry> = {
  ...
  "gemini-3-flash-video-analysis": {
    ...
    pricing: [
      { identifier: "video-analysis:gemini-3-flash", credits: 847, note: "10-min ceiling (no duration given)" },
      ...
      { identifier: "video-analysis:gemini-3-flash:600s", credits: 847, note: "10-min ceiling" },
    ],
  },
  "gemini-3.6-flash-video-analysis": {
    ...
    useCases: ["video-analysis", "shot-list", "fast"],
    pricing: [
      { identifier: "video-analysis:gemini-3.6-flash", credits: 990, note: "10-min ceiling (no duration given)" },
      { identifier: "video-analysis:gemini-3.6-flash:60s", credits: 204 },
      { identifier: "video-analysis:gemini-3.6-flash:180s", credits: 218 },
      { identifier: "video-analysis:gemini-3.6-flash:360s", credits: 600 },
      { identifier: "video-analysis:gemini-3.6-flash:600s", credits: 990, note: "10-min ceiling" },
    ],
  },
  "gemini-3.1-pro-video-analysis": {
    ...
    pricing: [
      { identifier: "video-analysis:gemini-3.1-pro", credits: 1053, note: "10-min ceiling (no duration given)" },
      { identifier: "video-analysis:gemini-3.1-pro:60s", credits: 216 },
      { identifier: "video-analysis:gemini-3.1-pro:180s", credits: 232 },
      { identifier: "video-analysis:gemini-3.1-pro:360s", credits: 639 },
      { identifier: "video-analysis:gemini-3.1-pro:600s", credits: 1053, note: "10-min ceiling" },
    ],
  },
  ...
  "mixed-video-analysis": {
    ...
    pricing: [
      { identifier: "video-analysis:mixed", credits: 1174, note: "10-min ceiling (no duration given)" },
      { identifier: "video-analysis:mixed:60s", credits: 269 },
      { identifier: "video-analysis:mixed:180s", credits: 290 },
      { identifier: "video-analysis:mixed:360s", credits: 727 },
      { identifier: "video-analysis:mixed:600s", credits: 1174, note: "10-min ceiling" },
    ],
  },
  ...
  "smart-video-analysis": {
    ...
    pricing: [
      { identifier: "video-analysis:smart", credits: 2071, note: "10-min ceiling (no duration given)" },
      { identifier: "video-analysis:smart:60s", credits: 412 },
      { identifier: "video-analysis:smart:180s", credits: 502 },
      { identifier: "video-analysis:smart:360s", credits: 1264 },
      { identifier: "video-analysis:smart:600s", credits: 2071, note: "10-min ceiling" },
    ],
  },
  ...
  "video-audit": {
    ...
    pricing: [
      { identifier: "video-audit", credits: 1070, note: "10-min ceiling (no duration given)" },
      { identifier: "video-audit:60s", credits: 214 },
      { identifier: "video-audit:180s", credits: 290 },
      { identifier: "video-audit:360s", credits: 661 },
      { identifier: "video-audit:600s", credits: 1070, note: "10-min ceiling" },
    ],
  },
  "video-audit-auto": {
    id: "video-audit-auto",
    ...
    pricing: [
      { identifier: "video-audit:auto", credits: 1917, note: "10-min ceiling (no duration given)" },
      { identifier: "video-audit:auto:60s", credits: 394 },
      { identifier: "video-audit:auto:180s", credits: 475 },
      { identifier: "video-audit:auto:360s", credits: 1176 },
      { identifier: "video-audit:auto:600s", credits: 1917, note: "10-min ceiling" },
    ],
  },
}
