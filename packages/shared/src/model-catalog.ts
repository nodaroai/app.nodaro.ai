...
const VIDEO_MODELS: Record<string, ModelCatalogEntry> = {
  ...
  "gemini-3.6-flash-video-analysis": {
    ...
    useCases: ["video-analysis", "shot-list", "fast"],
    pricing: [
      { identifier: "video-analysis:gemini-3.6-flash", credits: 988, note: "10-min ceiling (no duration given)" },
      { identifier: "video-analysis:gemini-3.6-flash:60s", credits: 203 },
      { identifier: "video-analysis:gemini-3.6-flash:180s", credits: 218 },
      { identifier: "video-analysis:gemini-3.6-flash:360s", credits: 599 },
      { identifier: "video-analysis:gemini-3.6-flash:600s", credits: 988, note: "10-min ceiling" },
    ],
  },
  "gemini-3.1-pro-video-analysis": {
    ...
    pricing: [
      { identifier: "video-analysis:gemini-3.1-pro", credits: 1052, note: "10-min ceiling (no duration given)" },
      { identifier: "video-analysis:gemini-3.1-pro:60s", credits: 215 },
      { identifier: "video-analysis:gemini-3.1-pro:180s", credits: 232 },
      { identifier: "video-analysis:gemini-3.1-pro:360s", credits: 638 },
      { identifier: "video-analysis:gemini-3.1-pro:600s", credits: 1052, note: "10-min ceiling" },
    ],
  },
  ...
  "mixed-video-analysis": {
    ...
    pricing: [
      { identifier: "video-analysis:mixed", credits: 1171, note: "10-min ceiling (no duration given)" },
      { identifier: "video-analysis:mixed:60s", credits: 269 },
      { identifier: "video-analysis:mixed:180s", credits: 290 },
      { identifier: "video-analysis:mixed:360s", credits: 725 },
      { identifier: "video-analysis:mixed:600s", credits: 1171, note: "10-min ceiling" },
    ],
  },
  ...
  "smart-video-analysis": {
    ...
    pricing: [
      { identifier: "video-analysis:smart", credits: 2068, note: "10-min ceiling (no duration given)" },
      { identifier: "video-analysis:smart:60s", credits: 411 },
      { identifier: "video-analysis:smart:180s", credits: 501 },
      { identifier: "video-analysis:smart:360s", credits: 1262 },
      { identifier: "video-analysis:smart:600s", credits: 2068, note: "10-min ceiling" },
    ],
  },
  ...
  "video-audit": {
    ...
    pricing: [
      { identifier: "video-audit", credits: 1068, note: "10-min ceiling (no duration given)" },
      { identifier: "video-audit:60s", credits: 214 },
      { identifier: "video-audit:180s", credits: 289 },
      { identifier: "video-audit:360s", credits: 660 },
      { identifier: "video-audit:600s", credits: 1068, note: "10-min ceiling" },
    ],
  },
  "video-audit-auto": {
    id: "video-audit-auto",
    ...
    pricing: [
      { identifier: "video-audit:auto", credits: 1915, note: "10-min ceiling (no duration given)" },
      { identifier: "video-audit:auto:60s", credits: 394 },
      { identifier: "video-audit:auto:180s", credits: 474 },
      { identifier: "video-audit:auto:360s", credits: 1175 },
      { identifier: "video-audit:auto:600s", credits: 1915, note: "10-min ceiling" },
    ],
  },
}
