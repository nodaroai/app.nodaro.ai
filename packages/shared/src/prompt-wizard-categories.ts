...
export const PROVIDER_CAPABILITIES: Record<string, Record<string, string>> = {
  ...
  "text-to-video": {
    ...
    "veo3_lite": "Cheapest VEO tier, same 8s output, ideal for high-volume/test runs",
  ...
  "image-to-video": {
    ...
    "veo3_lite": "Cheapest VEO tier — half the cost of Fast, same 8s + audio + first/last-frame",
