...
const map: LocaleCatalogMap = {
  ...
  "film-grain-heavy": { label: "粗いフィルム粒子", description: "増感現像のような粗い粒子" },
  ...
  "scratched-emulsion": { label: "乳剤の傷", description: "古びたフィルムの傷とほこり" },
  ...
  "sharpening": { label: "強いシャープニング", description: "強めのエッジシャープニング、くっきりとした微細なディテール" },
  "clarity-boost": { label: "明瞭度ブースト", description: "ミッドトーンの明瞭度強調、局所コントラストの増加" },
  "dehaze": { label: "霞除去", description: "大気のかすみを除去し、柔らかさを取り除いて霧越しのコントラストを高める" },
  "lift-gamma-gain": { label: "リフト・ガンマ・ゲイン・グレード", description: "3ウェイのカラーグレーディングホイール — シャドウのリフト、中間調のガンマ、ハイライトのゲイン" },
}
