...
const map: LocaleCatalogMap = {
  ...
  // Additional animals
  "capybara": { label: "Capivara", description: "Roedor sul-americano grande e tranquilo" },
  "sloth": { label: "Bicho-preguiça", description: "Mamífero arborícola lento com sorriso gentil" },
