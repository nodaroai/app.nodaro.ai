...
const map: LocaleCatalogMap = {
  ...
  "pixelate-reform": { label: "Пиксельная пересборка", description: "Пиксели рассыпаются и собираются в новый образ" },
  ...
  "melt-down": { label: "Расплавление", description: "Персонаж плавится как воск и поднимается вновь" },
