...
const map: LocaleCatalogMap = {
  ...
  "smoke-sculpture": { label: "Sculpture de fumée", description: "Sujet formé de fumée tourbillonnante" },
  "liquid-sculpture": { label: "Sculpture liquide", description: "Sujet formé de liquide en mouvement" },
  "shattering-glass": { label: "Verre brisé", description: "Éclats de verre figés en plein vol" },
  "emerging-from-background": { label: "Émergeant du fond", description: "À demi sortant d'une surface texturée" },
  "fragmented-mosaic": { label: "Mosaïque fragmentée", description: "Portrait composé de carreaux de mosaïque" },
  "glitch-distortion": { label: "Distorsion glitch", description: "Corruption numérique avec décalage RVB" },
  "doubled-mirror": { label: "Miroir doublé", description: "Duplication par reflet de miroir" },
