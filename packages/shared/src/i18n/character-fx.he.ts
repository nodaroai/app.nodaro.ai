...
const map: LocaleCatalogMap = {
  ...
  "none": { label: "ללא", description: "ללא אפקט על הדמות" },
  "werewolf": { label: "אדם-זאב", description: "הופך לאדם-זאב" },
  "vampire": { label: "ערפד", description: "הופך לערפד" },
  ...
  "animalization": { label: "הפיכה לחיה", description: "הופך לחיה" },
  "gorilla-form": { label: "צורת גורילה", description: "הופך לגורילה מסיבית" },
  ...
  "water-bending": { label: "כיפוף מים", description: "שולט במים זורמים באמצעות תנועות ידיים" },
  ...
  "hero-flight": { label: "טיסת גיבור", description: "מזנק לשמיים בתנוחת טיסת גיבור" },
  ...
  // ── Body-Mod ──
  "wings-grow": { label: "צמיחת כנפיים", description: "כנפיים צומחות ומתפרשות מהגב" },
  ...
  "tentacles-emerge": { label: "הופעת טנטקלים", description: "טנטקלים מתפתלים יוצאים מהגב" },
  ...
  "head-off": { label: "הסרת ראש", description: "הראש מתנתק וצף (PG-13, מסוגנן)" },
  ...
  "floral-eyes": { label: "עיניים פרחוניות", description: "פרחים פורחים מארובות העיניים" },
  ...
  "money-rain": { label: "גשם כסף", description: "שטרות כסף יורדים כגשם סביב הדמות" },
  ...
  "frost-aura": { label: "הילת כפור", description: "כפור וקרח בוקעים מהדמות" },
  "shadow-aura": { label: "הילת צל", description: "זרועות צל אפלות מתפתלות סביב הדמות" },
  "electricity-aura": { label: "הילה חשמלית", description: "קשתות חשמל כמו סליל טסלה סביב הדמות" },
  ...
  "petals-around": { label: "עלי כותרת סביב הדמות", description: "עלי כותרת של פריחת דובדבן מרחפים סביב הדמות" },
