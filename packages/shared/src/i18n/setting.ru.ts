...
const map: LocaleCatalogMap = {
  ...
  "balcony": { label: "Балкон", description: "Балкон квартиры или отеля, городской вид, интимный" },
  "attic": { label: "Чердак", description: "Пыльный чердак с деревянными балками и скошенной крышей" },
  "basement": { label: "Подвал", description: "Бетонный подвал, открытые трубы, тусклый индустриальный" },
  "sauna": { label: "Сауна", description: "Сауна с деревянными панелями, пар, интимное тепло" },
  "dorm-room": { label: "Комната в общежитии", description: "Студенческое общежитие, односпальная кровать, постеры, гирлянды" },
  "locker-room": { label: "Раздевалка", description: "Раздевалка спортзала, плитка, скамейки, зеркала" },
  "music-studio": { label: "Музыкальная студия", description: "Студия звукозаписи, микрофоны, поролон, пульт управления" },
  "conservatory": { label: "Зимний сад", description: "Стеклянная оранжерея, тропические растения, рассеянный солнечный свет" },
  // --- picker-gaps 2026-09-01 ---
  "open-air-market": { label: "Рынок под открытым небом", description: "Оживлённый рынок с торговыми лотками под навесами" },
}
