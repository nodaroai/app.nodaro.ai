...
const map: LocaleCatalogMap = {
  ...
  "ecu-eye": { label: "ECU: आँख", description: "Sergio Leone शैली का extreme close-up, एक आँख पर तंग" },
  "ecu-mouth": { label: "ECU: होंठ/मुँह", description: "मुँह, होंठ और दाँतों पर तंग extreme close-up" },
  "ecu-hands": { label: "ECU: हाथ", description: "हाथों पर तंग extreme close-up" },
  "big-close-up": { label: "Big Close-up (BCU)", description: "Standard close-up से तंग, बस ठोड़ी से माथे तक का चेहरा" },
  "choker": { label: "Choker Shot", description: "गले पर framed, केवल सिर और गर्दन, अंतरंग तीव्रता" },
  "italian-shot": { label: "Italian Shot / Trinity Shot", description: "Sergio Leone Western trope: केवल आँखों पर crop किया हुआ ECU" },
