...
const map: LocaleCatalogMap = {
  ...
  "ecu-eye": { label: "ECU: Глаз", description: "Сверхкрупный план в стиле Sergio Leone, сжатый на одном глазу" },
  "ecu-mouth": { label: "ECU: Губы/Рот", description: "Сверхкрупный план, сжатый на рте, губах и зубах" },
  "ecu-hands": { label: "ECU: Руки", description: "Сверхкрупный план, сжатый на руках" },
  "big-close-up": { label: "Большой крупный план (BCU)", description: "Плотнее стандартного крупного плана, только лицо от подбородка до лба" },
  "choker": { label: "Choker Shot", description: "Кадрирование на горле, только голова и шея, интимная интенсивность" },
  "italian-shot": { label: "Итальянский план / Trinity Shot", description: "Троп вестерна Sergio Leone: ECU с обрезкой только по глазам" },
