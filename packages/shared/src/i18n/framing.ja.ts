...
const map: LocaleCatalogMap = {
  ...
  "extreme-close-up": { label: "エクストリーム・クローズアップ", description: "顔のパーツに寄ったタイトなディテール" },
  "ecu-eye": { label: "ECU：目", description: "Sergio Leone風のエクストリーム・クローズアップ、片目に寄った構図" },
  "ecu-mouth": { label: "ECU：唇／口", description: "口元に寄ったエクストリーム・クローズアップ" },
  ...
  "choker": { label: "チョーカーショット", description: "頭と首だけを収めた、親密で強い印象の構図" },
  ...
  "overhead": { label: "真俯瞰", description: "真上からの神の視点" },
  "worms-eye-angle": { label: "ワームズアイ", description: "地面からの極端なローアングル" },
  "dutch-angle": { label: "ダッチアングル", description: "斜めに傾いた水平線" },
  ...
  "selfie-framing": { label: "自撮り", description: "腕を伸ばした自撮り" },
  "mirror-selfie": { label: "鏡の自撮り", description: "鏡の反射に映るスマホ" },
  "gym-mirror-selfie": { label: "ジムの鏡自撮り", description: "ジムの鏡越しに捉えた、斜め後方3/4の角度" },
  ...
  "centered": { label: "日の丸構図", description: "被写体を中央に置いた左右対称構図" },
  ...
  "profile-left": { label: "横顔（左）", description: "被写体の左側の横顔" },
  "profile-right": { label: "横顔（右）", description: "被写体の右側の横顔" },
  "three-quarter-back": { label: "後方3/4", description: "斜め後ろからのアングル" },
