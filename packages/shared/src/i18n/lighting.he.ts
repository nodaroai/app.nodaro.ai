...
const map: LocaleCatalogMap = {
  ...
  "split": { label: "Split", description: "חצי פנים מואר, חצי בצל" },
  "hard": { label: "קשה", description: "צללים עם קצוות חדים" },
  "soft": { label: "רך", description: "אור עדין מפוזר" },
  "practical": { label: "פרקטיקל", description: "אורות נראים בתוך הסצנה" },
  "ring-light": { label: "Ring Light", description: "Catchlight טבעתי לביוטי / vlog" },
  ...
  "noir": { label: "נואר", description: "Film noir שחור-לבן בקונטרסט גבוה" },
  "on-camera-flash": { label: "פלאש על המצלמה", description: "פלאש ישיר של פפראצי/iPhone" },
  "mirror-bounce-flash": { label: "פלאש מוקפץ ממראה", description: "הקפצת פלאש בסלפי במראה" },
  ...
  "beauty-dish": { label: "Beauty Dish", description: "אור גיבור, דעיכה חדה" },
  "gridded-snoot": { label: "Snoot עם גריד", description: "כתם אור הדוק וממוקד" },
  "silk-diffusion": { label: "פיזור משי", description: "Key רך עדין מפוזר במשי" },
  "kicker-rim": { label: "Kicker / Rim Accent", description: "אור הדגשה נמוך מהצד להפרדת הסובייקט" },
  ...
  "dappled-light": { label: "אור מנומר / מסונן דרך עלים", description: "אור מנומר דרך עלווה" },
  ...
  "underwater-caustics": { label: "Caustics תת-מימיים", description: "דגמי אור מרצדים ונשברים" },
  ...
  "back-rim": { label: "אחורי / Rim", description: "תאורה אחורית סביב הסובייקט" },
  "silhouette-backlight": { label: "תאורת צללית מאחור", description: "הילה בהירה, סובייקט כהה" },
  "top-overhead": { label: "עליון / מלמעלה", description: "אור ישירות מלמעלה" },
  ...
  "ratio-1-2": { description: "דעיכה רכה של סטופ אחד" },
  "ratio-1-3": { description: "קונטרסט מתון של שני סטופים" },
  "ratio-1-4": { description: "קונטרסט אדיטוריאלי חזק" },
  "ratio-1-8": { description: "Chiaroscuro Low-key קיצוני" },
  "ratio-1-16": { description: "דעיכה בסגנון film-noir ממקור יחיד" },
  ...
  "clamshell": { label: "Clamshell", description: "Key ביוטי מלמעלה + רפלקטור מלמטה" },
