...
const map: LocaleCatalogMap = {
  ...
  "shattering-glass": { label: "זכוכית מתנפצת", description: "שברי זכוכית קפואים באוויר" },
  "emerging-from-background": { label: "צץ מהרקע", description: "צץ למחצה ממשטח עם טקסטורה" },
  "fragmented-mosaic": { label: "פסיפס מקוטע", description: "פורטרט הבנוי מאריחי פסיפס" },
  "glitch-distortion": { label: "עיוות Glitch", description: "השחתה דיגיטלית עם הזזת RGB" },
  "doubled-mirror": { label: "מראה כפולה", description: "שכפול בהשתקפות מראה" },
