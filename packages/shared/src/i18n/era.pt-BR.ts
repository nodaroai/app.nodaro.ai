...
const map: LocaleCatalogMap = {
  ...
  "1920s-flapper": { label: "Anos 1920 Flapper", description: "Glamour da era do jazz e dos speakeasies" },
  ...
  "1960s-mod": { label: "Mod dos Anos 1960", description: "Gráfico mod de Londres" },
  ...
  "1990s-mall": { label: "Shopping dos Anos 1990", description: "Mall-rat noventista entre grunge e pop" },
  "2000s-y2k": { label: "Tabloide dos Anos 2000 / Y2K", description: "Tabloide low-rise sob flash de paparazzi" },
  ...
  "victorian": { label: "Vitoriana", description: "Século XIX corseted e rendado sob a luz a gás" },
  ...
  "roaring-prewar": { label: "Pré-Guerra Roaring", description: "Limiar da art-nouveau no fim dos anos 1910" },
  ...
  "atompunk": { description: "Otimismo da era atômica em estilo anos 1950" },
  "cyberpunk-future": { label: "Futuro Cyberpunk", description: "Megacidade neon de alta tecnologia e baixa vida" },
  "post-apocalyptic": { label: "Pós-apocalíptico", description: "Sobrevivência de sucateiros no terreno baldio" },
  "retrofuturism": { label: "Retrofuturismo", description: "Nostalgia do amanhã de ontem" },

  // Additional eras
  "atomic-age-50s": { label: "Era Atômica Anos 50", description: "Futurismo sci-fi dos anos 1950 com ansiedade da Guerra Fria" },
  "gen-z-2020s": { label: "Geração Z dos Anos 2020", description: "Composição phone-first, estilo TikTok-coded, revival Y2K" },
  "fin-de-siecle": { label: "Fin-de-siècle", description: "Elegância europeia da Belle Époque na virada do século" },
}
