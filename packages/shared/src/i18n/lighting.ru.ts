...
const map: LocaleCatalogMap = {
  ...
  "butterfly": { label: "Бабочка", description: "Свет сверху отбрасывает тень-бабочку под носом" },
  "loop": { label: "Петля", description: "Свет слегка сбоку и сверху, маленькая петля на щеке" },
  "broad": { label: "Широкий", description: "Освещена сторона, обращённая к камере, лицо выглядит шире" },
