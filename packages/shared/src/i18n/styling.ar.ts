...
const map: LocaleCatalogMap = {
  ...
  "headwear-nemes": { label: "غطاء النمس", description: "نمس فرعوني مخطط مع الصل الملكي" },
  ...
  "face-paint-flag": { label: "علم على الوجه", description: "علم وطني مرسوم على الخدين بأسلوب المشجعين" },
  ...
  "outfit-sundress": { label: "فستان صيفي / ماكسي", description: "فستان صيفي انسيابي برقبة هالتر / ماكسي منقوش" },
  ...
  "outfit-soccer-jersey": { label: "قميص كرة قدم", description: "قميص منتخب وطني مع الشعار" },
  ...
  "state-halter-neck": { label: "رقبة هالتر", description: "أشرطة معقودة خلف الرقبة" },
  "state-plunging-neck": { label: "فتحة صدر عميقة", description: "فتحة صدر على شكل V عميقة" },
  ...
  "outfit-pharaoh": { label: "زي فرعوني", description: "ملوك مصر القديمة: قلادة أوسخ، صدرية، نقبة مطوية" },
