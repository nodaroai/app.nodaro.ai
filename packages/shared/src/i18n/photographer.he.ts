...
const map: LocaleCatalogMap = {
  ...
  "steven-meisel": { description: "פורטרט אדיטוריאלי מהמאה ה-20 מלוטש" },
  ...
  "oleg-oprisco": { description: "סיפור גרגירי-פילם קולנועי" },
  "bella-kotak": { description: "פורטרטיקה פנטזיה-פולקלורית קסומה" },
  "yigal-ozeri": { description: "פורטרט מצויר היפר-ריאלי" },
  "jimmy-marble": { description: "אדיטוריאלי בצבעי פסטל בהירים" },
  ...
  "robert-capa": { description: "פוטו-ז'ורנליזם קרבי קרבי" },
  "sebastiao-salgado": { description: "דוקומנטרי חברתי מונוכרומטי אפי" },
  "diane-arbus": { description: "פורטרט עז ועימותי" },

  // Cinematographers
  "roger-deakins": { description: "נטורליזם קולנועי ציורי" },
  "emmanuel-lubezki": { description: "צילום קולנועי מרחף באור טבעי" },
  "greig-fraser": { description: "צילום קולנועי ז'אנר עשיר ומוחשי" },
  "christopher-doyle": { description: "מצב רוח ניאון רווי בצילום יד" },
  ...
  "studio-ghibli": { description: "חמימות Ghibli צבועה ביד" },
  "alphonse-mucha": { description: "פאנל דקורטיבי art-nouveau" },
  "carne-griffiths": { description: "פורטרטיקה בוטנית עם ריבוץ דיו" },
  "conrad-roset": { description: "איור דמות בצבעי מים עדין" },
  "akihito-yoshida": { description: "פורטרטיקה מונוכרומטית של דיו וגרגירים שקטה" },
  "karol-bak": { description: "מוזה צבועה סימבוליסטית" },
