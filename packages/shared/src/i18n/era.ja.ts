...
const map: LocaleCatalogMap = {
  ...
  // Pre-modern
  "medieval": { label: "中世", description: "石造りの城とヨーロッパ中世" },
  "renaissance": { label: "ルネサンス", description: "フィレンツェのベルベットとフレスコの壮麗さ" },
  "victorian": { label: "ヴィクトリアン", description: "ガス灯下のコルセットとレースの19世紀" },
  "edwardian": { label: "エドワーディアン", description: "ベル・エポックのティーガーデンの優雅さ" },
