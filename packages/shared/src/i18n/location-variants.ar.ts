// TODO(translator): translate values into Arabic (ar). Keys are stable —
// do NOT translate them. RTL: pickers already flip direction via the locale
// registry. Reference English source-of-truth at `location-variants.en.ts`.
//
