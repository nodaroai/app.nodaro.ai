...
const map: LocaleCatalogMap = {
  ...
  "kodak-vision3": { description: "פילם קולנוע" },
  ...
  "technicolor": { label: "Technicolor תלת-פסי", description: "Technicolor רטרו תוסס" },
  ...
  "day-for-night": { label: "Day-for-Night", description: "אור יום עם גריידינג של לילה" },
  ...
  "aerochrome": { description: "עלווה בגוון ורוד-מג'נטה סוריאליסטי, נוף בצבע מדומה" },
