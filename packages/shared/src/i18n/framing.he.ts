...
const map: LocaleCatalogMap = {
  ...
  "overhead": { label: "מלמעלה", description: "מבט אלוהי מלמעלה ישירות" },
  ...
  "birds-eye": { label: "מעוף הציפור", description: "מבט אווירי גבוה מלמעלה" },
  ...
  "over-the-shoulder-framing": { label: "מעבר לכתף", description: "מעבר לכתף של אחד אל השני" },
  ...
  "through-glass": { label: "דרך זכוכית", description: "ממוסגר דרך לוח זכוכית בחזית" },
  ...
  "leading-lines": { label: "קווים מובילים", description: "קווים מובילים את העין לסובייקט" },
  "3x3-grid-collage": { label: "קולאז' רשת 3×3", description: "סובייקט ברשת 3×3 של וריאציות" },
  "diptych": { label: "דיפטיך", description: "קומפוזיציה דו-פריימית זה לצד זה" },
  "triptych": { label: "טריפטיך", description: "קומפוזיציה תלת-פריימית" },
  "multi-frame-mosaic": { label: "פסיפס רב-פריימי", description: "פנים בנויות מפסיפס של אריחים קטנים" },
  "contact-sheet": { label: "Contact Sheet", description: "Contact Sheet של תמונות ממוזערות" },
  "magazine-spread": { label: "כפולת מגזין", description: "פריסת מגזין דו-עמודית עם טיפוגרפיה" },
  "cutaway-cross-section": { label: "Cutaway / Cross-Section", description: "חתך אדריכלי עם קירות מקולפים" },

  "front-on": { label: "חזיתי", description: "סובייקט פונה למצלמה" },
  "three-quarter-front": { label: "שלושת רבעי מלפנים", description: "מעט מחוץ לציר מלפנים" },
  ...
  "three-quarter-back": { label: "שלושת רבעי מאחור", description: "מחוץ לציר מאחור" },
  "behind": { label: "מאחור", description: "מבט אחורי ישיר" },
  "side-back-angle": { label: "זווית צד-אחור", description: "מבט 3/4 מאחורי כתף אחת" },
  "golden-spiral": { label: "ספירלת הזהב", description: "קומפוזיציה על ספירלת Fibonacci" },
