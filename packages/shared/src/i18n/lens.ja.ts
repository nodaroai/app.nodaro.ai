...
const map: LocaleCatalogMap = {
  ...
  "standard-35mm": { label: "準広角（35mm）", description: "自然な遠近感、ドキュメンタリー的" },
  "normal-50mm": { label: "標準（50mm）", description: "人間の目に最も近い知覚" },
  ...
  "cooke-s4": { description: "Cooke 特有の描写 — 絵画的でクリーミーな肌" },
  "helios-44": { description: "ヴィンテージのソビエト製ぐるぐるボケ" },
  "petzval": { label: "ペッツバール・ポートレート", description: "超ヴィンテージなぐるぐるボケ、劇的な周辺減光" },
