...
const map: LocaleCatalogMap = {
  ...
  "dslr": { label: "DSLR", description: "מראה וידאו-DSLR חד" },
  "mirrorless-a7iii": { description: "מצלמה ללא מראה היברידית מודרנית" },
  "canon-r5": { description: "מצלמה ללא מראה ברזולוציה גבוהה לאדיטוריאל אופנה" },
  ...
  "camcorder": { label: "מצלמת וידאו ביתית", description: "וידאו צרכני של שנות ה-90" },
