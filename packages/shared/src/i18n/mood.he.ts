...
const map: LocaleCatalogMap = {
  // Positive
  "happy": { label: "שמח", description: "אושר חמים ומחויך" },
  "joyful": { label: "עליז", description: "שמחה זוהרת ובלתי מרוסנת" },
  "serene": { label: "שלו", description: "שלוות נפש רגועה" },
  ...
  "amused": { label: "מבודר", description: "משועשע בעדינות, עם חיוך מהורהר" },
  ...
  // Negative
  "sad": { label: "עצוב", description: "עצוב בשקט, מבט מורד" },
  "angry": { label: "כועס", description: "כעס ברור, מתח" },
  ...
  "devastated": { label: "מנופץ", description: "אבל שבור-לב" },
  ...
  "coy": { label: "מתוחכם", description: "ביישן, מבט מורד" },
  "bored": { label: "משועמם", description: "חסר עניין, חסר הבעה" },
  "embarrassed": { label: "נבוך", description: "מסמיק, עיניים מסיטות" },
  "disgusted": { label: "מגועל", description: "סולד, נסוג" },
  "bewildered": { label: "מבולבל", description: "מבולבל, אבוד" },

  // Neutral
  "thoughtful": { label: "מהורהר", description: "שקוע במחשבה" },
  ...
  "mysterious": { label: "מסתורי", description: "אינסקרוטבילי, חידתי" },
  "dazed": { label: "מטומטם", description: "חולמני, נוכח לחצי" },
  "sleepy": { label: "מנומנם", description: "מנמנם, עפעפיים כבדים" },
  "unbothered": { label: "לא מוטרד", description: "שליטה עצמית רגועה" },

  // Intense
  "fierce": { label: "עז", description: "עז ומצווה" },
  ...
  "sultry": { label: "חושני", description: "מעשן, עם עפעפיים כבדים" },
  "smoldering": { label: "בוער לאט", description: "עוצמה כרוכה ובוערת לאט" },
  "sinister": { label: "מאיים", description: "כהה, זדוני, מאיים" },
  "wiccan-mystical": { label: "Wiccan / מיסטי", description: "אחר-עולמי בשקט, אזוטרי" },
  ...
  "relieved": { label: "מוקל", description: "המתח משתחרר לרוגע" },
}
