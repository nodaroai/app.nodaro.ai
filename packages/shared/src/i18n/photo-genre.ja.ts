...
const map: LocaleCatalogMap = {
  ...
  "lookbook": { label: "ルックブック", description: "クリーンなルックブックのコーディネートショット" },
  ...
  "campaign-advertising": { label: "キャンペーン／広告", description: "洗練されたブランドキャンペーン写真" },
  ...
  "brand-jil-sander": { label: "Jil Sander ミニマリズム", description: "Jil Sander — ミニマルで建築的、抑えたトーン" },
  "brand-vivienne-tam": { label: "Vivienne Tam スタイル", description: "Vivienne Tam — オリエンタルで装飾的なファッション" },
  "brand-jacquemus": { label: "Jacquemus スタイル", description: "Jacquemus — 陽光あふれる、シュールで遊び心のある世界" },
  ...
  "street-photography": { label: "ストリートフォト", description: "ポーズをとらない都会のストリートスナップ" },
  ...
  "lofi-baddie-selfie": { label: "ローファイ2010年代自撮り", description: "初期iPhoneの低光量自撮り" },
  ...
  "real-estate": { label: "不動産", description: "広角で捉えた建築的な室内ショット" },
  "sports-action": { label: "スポーツアクション", description: "望遠で動きを止めたスポーツの瞬間" },

  // Additional genres
  "point-and-shoot": { label: "コンパクト／使い捨てカメラ", description: "使い捨てカメラ／コンパクトカメラ風のカジュアルな雰囲気" },
  "lifestyle-blog": { label: "ライフスタイルブログ", description: "柔らかな自然光の、暮らし系ブロガー風" },
