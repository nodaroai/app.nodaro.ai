...
const map: LocaleCatalogMap = {
  ...
  "blizzard-whiteout": { label: "ホワイトアウト", description: "視界を完全に奪う猛吹雪" },
  ...
  "lava-flow": { label: "溶岩流", description: "輝く溶岩の川が地面を這うように進む" },
  "ash-rain": { label: "降灰", description: "雪のように降る終末的な灰色の火山灰" },
  "avalanche": { label: "雪崩", description: "山腹を転がり落ちる雪の壁" },
  "hailstorm": { label: "雹の嵐", description: "大きな雹が表面で跳ね返る" },

  // ── Fire & Blasts ──
  "explosion-small": { label: "小爆発", description: "中心に閃光を放つ小規模な爆発" },
  ...
  "fireball-airborne": { label: "空中火球", description: "空中で渦を巻く炎の球" },
  "gas-explosion": { label: "ガス爆発", description: "プロパンガスが燃え上がるような明るい爆発" },
  "oil-fire": { label: "油火災", description: "高く燃え上がる油の炎と濃い黒煙" },
  "blazing-inferno": { label: "燃え盛る業火", description: "すべてを焼き尽くす炎の壁" },
  "flame-burst": { label: "火炎放射", description: "一方向へ素早く噴き出す炎" },
  "ember-shower": { label: "火の粉のシャワー", description: "輝くオレンジの火の粉が降り注ぐ" },
  "smoke-pillar": { label: "煙の柱", description: "黒煙の高い垂直の柱" },
  "mushroom-cloud": { label: "きのこ雲", description: "傘と柱からなる典型的な爆発雲" },

  // ── Electric ──
  "lightning-bolt": { label: "稲妻", description: "嵐の空を走る枝分かれする稲光" },
  "lightning-strike-impact": { label: "落雷", description: "光の爆発を伴う地面への落雷" },
  "lightning-storm": { label: "雷の嵐", description: "同時に発生する複数の落雷" },
  ...
  "gunshot-impact": { label: "着弾", description: "弾丸が表面に当たり破片を撒き散らす" },
  "bullet-trail": { label: "弾道", description: "空中を切り裂く目に見える弾丸の軌跡" },
  "sword-spark": { label: "剣の火花", description: "金属同士の摩擦で飛び散る火花をマクロで捉える" },
  "blade-clash": { label: "刃の衝突", description: "衝撃波を伴う二つの刃の交錯" },
  "ricochet-spark": { label: "跳弾の火花", description: "金属に跳ね返る弾丸と火花" },
  "debris-field": { label: "飛散する破片", description: "空中に静止した破片が四方に散る" },
  ...
  "force-field-impact": { label: "フォースフィールドへの衝撃", description: "弾がシールドに当たった箇所に広がる波紋" },
  ...
  "ion-storm": { label: "イオンストーム", description: "宇宙を背景に荷電粒子がバチバチと弾ける空間" },
  ...
  "light-explosion": { label: "光の爆発", description: "純白と黄金の光がほとばしる爆発" },
}
