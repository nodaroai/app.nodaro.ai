// TODO(translator): translate values into Hebrew (he). Keys are stable —
// do NOT translate them. RTL: pickers already flip direction via the locale registry. Reference English source-of-truth at `location-variants.en.ts`.
//
