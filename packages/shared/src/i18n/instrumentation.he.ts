...
const map: LocaleCatalogMap = {
  ...
  "breakbeats": { label: "ברייקביטס", description: "לולאות תופים מדוגמות" },
  "trap-drums": { label: "תופי טראפ", description: "רולים של היי-האט + 808" },
  ...
  "maracas": { label: "מראקס", description: "זוג שייקרים לטיניים" },
  "claves": { label: "קלאוויס", description: "מקלות עץ" },
  "marimba": { label: "מרימבה", description: "כלי הקשה בפטישים עם לוחות עץ" },
  ...
  "clavinet": { label: "קלאווינט", description: "Hohner D6 פאנקי" },
  ...
  "mellotron": { label: "מלוטרון", description: "קלידים עם לולאות טייפ" },
  ...
  "wobble-bass": { label: "בס וובל", description: "דאבסטפ מאופנן LFO" },
  "reese-bass": { label: "בס Reese", description: "דראם-אנד-בס בכיוון מוסט" },

  // -------------------- INSTRUMENTS: Brass --------------------
  "brass": { label: "סקשן נשיפה", description: "חצוצרה, טרומבון וכו׳" },
  ...
  "saxophone": { label: "סקסופון", description: "סקס סולו או בסקשן" },
  ...
  // -------------------- INSTRUMENTS: Strings --------------------
  "strings": { label: "סקשן מיתרים", description: "סקשן מיתרים תזמורתי" },
  ...
  "tabla": { label: "טאבלה", description: "תופי יד הודיים" },
  ...
  "santur": { label: "סנטור", description: "דולצימר פרסי מוקש בפטישים" },

  // -------------------- PRODUCTION_STYLES --------------------
  "polished": { label: "מלוטשת", description: "הפקה נקייה ומיינסטרים" },
  "lo-fi": { description: "רחש טייפ חמים, לא מושלם" },
  ...
  "garage-band": { label: "להקת גראז׳", description: "DIY, מוקלטת במרתף" },
  ...
  "tape-saturated": { label: "טייפ רווי", description: "חמימות טייפ אנלוגי + דרייב" },
  ...
  "falsetto": { label: "פלסטו", description: "רגיסטר גבוה, קל" },
  "head-voice": { label: "קול ראש", description: "רגיסטר גבוה מהדהד" },
  "chest-voice": { label: "קול חזה", description: "רגיסטר נמוך וחזק" },
  ...
  "yodeling": { label: "יודלינג", description: "מעבר רגיסטר אלפיני" },
  "throat-singing": { label: "שירת גרון", description: "אובר-טון מונגולי / טובאני" },
  "melismatic": { label: "מליסמטי", description: "סלסולים מרובי צלילים בכל הברה" },
  ...
  "chant": { label: "מזמור", description: "מזמור ליטורגי / שירת נזירים" },
}
