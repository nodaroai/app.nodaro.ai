...
const map: LocaleCatalogMap = {
  ...
  "headwear-nemes": { label: "Nemes-Kopftuch", description: "Gestreiftes Pharaonen-Nemes mit Uräus" },
  ...
  "face-paint-flag": { label: "Flaggen-Gesichtsbemalung", description: "Nationalflagge auf die Wangen gemalt, Fan-Look" },
  ...
  "outfit-sundress": { label: "Sommerkleid / Maxi", description: "Fließendes Neckholder-Sommerkleid / gemustertes Maxikleid" },
  ...
  "outfit-soccer-jersey": { label: "Fußballtrikot", description: "Nationalmannschafts-Trikot mit Wappen" },
  ...
  "outfit-pharaoh": { label: "Pharaonen-Ornat", description: "Altägyptisches Königsornat: Usech-Kragen, Pektoral, plissierter Schurz" },
  // Top
  ...
  "state-halter-neck": { label: "Neckholder", description: "Träger im Nacken gebunden" },
  "state-plunging-neck": { label: "Tiefer Ausschnitt", description: "Tiefer V-Ausschnitt" },
