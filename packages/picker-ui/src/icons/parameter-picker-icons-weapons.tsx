...
const WEAPON_EMOJI: Record<string, string> = {
  // swords
  katana: "⚔️🇯🇵", longsword: "⚔️", broadsword: "⚔️🛡️", rapier: "🤺",
  saber: "⚔️💫", scimitar: "⚔️🌙", claymore: "⚔️🏴󠁧󠁢󠁳󠁣󠁴󠁿", cutlass: "🏴‍☠️",
  wakizashi: "⚔️🎋", falchion: "⚔️🔥",
  // daggers
  dagger: "🗡️", "bowie-knife": "🔪", kukri: "🗡️🪃", stiletto: "🗡️💎",
  dirk: "🗡️🏴󠁧󠁢󠁳󠁣󠁴󠁿", tanto: "🗡️🇯🇵", switchblade: "🔪💨", "trench-knife": "🗡️🪖",
  // axes
  "battle-axe": "🪓", tomahawk: "🪓🏹", hatchet: "🪓🌲", halberd: "🪓🔱",
  greataxe: "🪓💪", "bearded-axe": "🪓🧔",
  // polearms
  spear: "🔱", lance: "🔱🏇", pike: "🔱⬆️", glaive: "🔱⚔️", trident: "🔱🌊", naginata: "🔱🎋",
  // bows
  longbow: "🏹", "recurve-bow": "🏹🎯", "compound-bow": "🏹⚙️",
  crossbow: "🏹🪤", "short-bow": "🏹🏃",
  // blunt
  mace: "🔨", "war-hammer": "🔨⚔️", club: "🏏", "morning-star": "🔨⭐",
  flail: "⛓️", nunchaku: "🥋",
  // throwing
  ...
  // historical firearms
  musket: "🔫📜", "flintlock-pistol": "🔫🏴‍☠️", blunderbuss: "🔫📯", "dueling-pistol": "🔫🎩",
  // explosives & siege
