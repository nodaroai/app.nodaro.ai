        ...
        {framings.map((framing) => {
          ...
          return (
            <div key={framing.id} className="relative">
              ...
              >
                <LookArt pickerKey="framing" id={framing.id} className="w-full aspect-video" width={240} fallback={<FramingPreview framingId={framing.id} className="w-full aspect-square" />} />
                <FitText
                  text={entryLabel}
                  className={cn(
