...
import { ERAS as BASE_ERAS, ERA_CATEGORY_LABELS, ERA_CATEGORY_ORDER, type Era, type EraCategory } from "@nodaro/prompts"
...
export const EraPicker = memo(function EraPicker({
  ...
  const ERAS = useCuratedEntries("era", BASE_ERAS)
