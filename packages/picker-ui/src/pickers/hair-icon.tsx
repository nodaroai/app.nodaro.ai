...
/**
 * Tiny silhouette icons for Styling's hair-cut dimension. Each icon is a
...
const HAIR_SHAPES: Record<string, JSX.Element> = {
  ...
  "cut-buzz-cut": h("M20 26 Q32 22 44 26 Q44 30 40 30 L24 30 Q20 30 20 26 Z"),
  "cut-crew-cut": h("M20 24 Q32 18 44 24 Q44 30 40 30 L24 30 Q20 30 20 24 Z"),
  "cut-shaved": <></>,
  "cut-undercut": (
    <g>
  ...
  "cut-mohawk": h("M28 6 Q32 2 36 6 L36 28 L28 28 Z"),
  "cut-pompadour": (
    <g>
  ...
  "cut-short": h("M18 22 Q32 14 46 22 Q46 32 42 32 L22 32 Q18 32 18 22 Z"),
  "cut-short-curly": (
    <g>
      {circle(22, 22, 5)}
      {circle(30, 18, 6)}
...
export function HairIcon({
  ...
  const shape = HAIR_SHAPES[hairCutId]
  return (
    <svg
      viewBox="0 0 64 64"
      className={className}
