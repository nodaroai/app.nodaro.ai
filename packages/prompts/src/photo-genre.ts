...
export const PHOTO_GENRES: ReadonlyArray<PhotoGenre> = [
  ...
  { id: "magazine-cover",         label: "Magazine Cover",         category: "editorial",      description: "Tightly framed cover composition",  term: "magazine cover photography", promptHint: "framed as a magazine cover with a tight head-and-shoulders composition, strong eye contact with the lens, generous headroom for a masthead and a saturated punchy color grade" },
  ...
  { id: "campaign-advertising",   label: "Campaign / Ad",          category: "editorial",      description: "Polished brand campaign image",     term: "brand campaign photography", promptHint: "shot as a polished brand campaign image, bold visual hook, strong product or wardrobe presence and an aspirational lighting setup designed to read on a billboard" },

  // -------------------- Brand / Editorial Reference --------------------
  { id: "brand-vogue",            label: "Vogue Signature",        category: "editorial",      description: "Vogue magazine editorial signature",     term: "vogue magazine editorial style", promptHint: "shot in the signature language of a Vogue magazine editorial, clean polished beauty lighting, glossy makeup, sculpted hair and a wardrobe of polished glamour, with the controlled high-fashion sheen unique to Vogue's print pages" },
  { id: "brand-dior",             label: "Dior Signature",         category: "editorial",      description: "Dior editorial — chiaroscuro and silhouette", term: "dior editorial style", promptHint: "shot in the signature language of a Dior editorial, dramatic chiaroscuro carving the subject from deep shadow, a sculptural couture silhouette and the brand's restrained Parisian elegance" },
  ...
  // -------------------- Documentary / Candid --------------------
  { id: "paparazzi",              label: "Paparazzi",              category: "documentary",    description: "Flash-blown tabloid candid",        term: "paparazzi flash candid", promptHint: "shot as a paparazzi tabloid candid, harsh on-camera flash blowing out the highlights, slight motion blur, low candid angle, blurred crowd in the background and grainy cropped tabloid framing" },
  ...
  { id: "candid-journalism",      label: "Candid Journalism",      category: "documentary",    description: "Unposed photojournalist moment",    term: "candid photojournalism", promptHint: "captured as candid photojournalism, unposed expression, naturalistic available light, slightly off-balance composition and a documentary honesty rather than glamour" },
  ...
  { id: "documentary",            label: "Documentary",            category: "documentary",    description: "Long-form documentary portrait",    term: "documentary portrait", promptHint: "shot in a long-form documentary portrait style, soft window light, subject lightly aware of the camera, environmental context behind them and an unhurried observational tone" },
  { id: "snapshot",               label: "Snapshot",               category: "documentary",    description: "Casual amateur snapshot",           term: "casual amateur snapshot", promptHint: "shot as a casual amateur snapshot with on-camera flash, slightly wonky framing, ordinary domestic background and the warmth of an unposed personal moment" },
  ...
  { id: "personal-branding",      label: "Personal Branding",      category: "studio-formal",  description: "Modern personal-brand portrait",    term: "personal branding portrait", promptHint: "shot as a modern personal-branding portrait, warm soft key light, lifestyle environment lightly blurred behind the subject and a relaxed open expression" },
  { id: "yearbook",               label: "Yearbook",               category: "studio-formal",  description: "School yearbook portrait",          term: "yearbook portrait", promptHint: "shot as a school yearbook portrait with even soft front lighting, a graduated grey or marbled studio backdrop and a closed-mouth posed smile centered in the frame" },
  { id: "id-passport",            label: "ID / Passport",          category: "studio-formal",  description: "Regulation passport photo",         term: "passport photo", promptHint: "shot as a regulation passport photograph, dead-center face, neutral expression, plain off-white backdrop, even flat front lighting and no shadows under the chin" },
  ...
  { id: "front-cam-selfie",       label: "Front Cam Selfie",       category: "selfie",         description: "Arm-extended front camera selfie",  term: "front-camera selfie", promptHint: "shot as a front-camera selfie taken at arm's length, the lens slightly above the subject's eye line, soft ambient lighting, natural skin texture and the casual intimacy of a phone-held self portrait" },
  ...
  { id: "bereal-dual",            label: "BeReal Dual",            category: "selfie",         description: "Front+back simultaneous dual frame", term: "bereal dual-camera capture", promptHint: "framed as a BeReal-style dual capture with a small inset front-camera selfie tucked in the corner of a wider rear-camera environmental shot, casual unstaged moment and slightly soft phone-camera quality" },
  { id: "flip-cam-selfie",        label: "Flip-Cam Selfie",        category: "selfie",         description: "Accidental low-quality flip cam",   term: "lo-fi camcorder selfie", promptHint: "shot as an accidental flip-cam selfie, low-resolution camcorder feel, harsh on-board video light, off-center framing and a candid ordinary expression caught mid-thought" },
  ...
  { id: "lofi-baddie-selfie",     label: "Lo-Fi 2010s Selfie",     category: "selfie",         description: "Early-iPhone low-light selfie",     term: "lo-fi 2010s iphone selfie", promptHint: "shot as a lo-fi 2010s iPhone selfie with grainy low-light noise, slight green-yellow color cast, mirror reflection of an early-era phone and the unpolished aesthetic of an early-Instagram baddie post" },

  // -------------------- Print / Context --------------------
  { id: "album-cover",            label: "Album Cover",            category: "print-context",  description: "Square album cover composition",    term: "album cover photography", promptHint: "composed as a square album cover, bold central subject, dramatic single-color or saturated graphic backdrop, deliberate negative space for an artist title and a stylized lighting setup" },
  { id: "movie-poster",           label: "Movie Poster",           category: "print-context",  description: "Cinematic theatrical poster",       term: "movie poster key art", promptHint: "composed as a theatrical movie poster, dramatic key art lighting, layered subjects in a dynamic composition, a cinematic teal-and-orange color grade and clear space along the bottom for credits" },
  { id: "advertising",            label: "Advertising",            category: "print-context",  description: "Glossy ad-campaign photograph",     term: "glossy advertising photography", promptHint: "shot as a glossy advertising photograph, hyper-clean studio lighting, idealized colors, the product or wardrobe positioned as the visual hero and a print-ready composition with copy space" },
  ...
  { id: "real-estate",            label: "Real Estate",            category: "print-context",  description: "Wide architectural interior",       term: "real estate listing photography", promptHint: "shot as a wide-angle real-estate listing photograph, ultra-wide lens emphasizing space, neutral white-balanced light, all rooms tidied to perfection and clean horizontal/vertical lines" },
  { id: "sports-action",          label: "Sports Action",          category: "print-context",  description: "Telephoto frozen sports moment",    term: "sports action photography", promptHint: "shot as a telephoto sports-action photograph, frozen peak-action moment, blurred crowd background, dramatic stadium lighting and a slightly desaturated press-photo grade" },

  // -------------------- Lifestyle --------------------
  { id: "point-and-shoot",        label: "Point-and-Shoot / Disposable", category: "lifestyle",   description: "Disposable / P&S casual aesthetic", term: "point-and-shoot disposable camera snapshot", promptHint: "shot in a point-and-shoot disposable-camera aesthetic, harsh on-camera flash blowing out the foreground, slight motion blur, casual unposed framing and the warm grainy quality of a single-use 35mm camera" },
  { id: "lifestyle-blog",         label: "Lifestyle Blog",         category: "lifestyle",      description: "Soft natural-light home blogger feel", term: "lifestyle blog photography", promptHint: "shot as a lifestyle-blog image, soft natural window light, cozy home or coffee morning-routine setting, gentle pastel color grade and the airy aspirational warmth of an instagram-blogger feed" },
...
export function getPhotoGenreTerm(id: string | undefined | null): string {
  return resolveTerm(getPhotoGenre(id))
}
