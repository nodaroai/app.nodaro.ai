...
export const CAMERA_FORMATS: ReadonlyArray<CameraFormat> = [
  ...
  { id: "super-8",            label: "Super 8",           description: "Vintage 8mm home-movie look",                promptHint: "shot on Super 8 film, soft vintage grain with warm color cast and subtle gate weave", term: "super 8mm film" },
  ...
  { id: "red-komodo",             label: "RED Komodo",            description: "Compact 6K action cinema camera",            promptHint: "shot on a RED Komodo 6K cinema camera, compact-body REDCODE RAW capture with crisp action-grade detail, RED IPP2 color science, and dynamic gimbal- or drone-friendly framing", term: "red komodo cinema camera" },
  ...
  { id: "voigtlander",            label: "Voigtlander",           description: "Boutique rangefinder character",             promptHint: "shot on a Voigtlander rangefinder, distinctive color rendition with subtle vintage character, slightly muted saturation, and unique micro-contrast signature", term: "voigtlander rangefinder" },
  ...
  // Aerial / action
  { id: "drone-aerial",           label: "Drone (Aerial)",        description: "Overhead gimbal-stabilized aerial",          promptHint: "overhead drone aerial footage, slight wide-angle distortion with smooth gimbal stabilization, top-down or low-altitude perspective, and atmospheric haze on distant subjects", term: "aerial drone footage" },
  ...
  // Lo-fi modern
  { id: "webcam-facetime",        label: "Webcam / FaceTime",     description: "Low-res video call",                         promptHint: "low-resolution webcam or FaceTime call footage, soft compression artifacts with color-shifted skin tones, low frame-rate ghosting, and slightly laggy motion blur", term: "webcam video call footage" },
  // Vintage / lo-fi
  ...
  { id: "camcorder",              label: "Camcorder",             description: "Consumer 90s video",                         promptHint: "shot on a 90s consumer camcorder, soft video with low resolution and slight chromatic fringing", term: "90s consumer camcorder" },
  ...
  { id: "toy-camera-holga",       label: "Toy Camera (Holga)",    description: "Lo-fi Holga / Lomo plastic-lens",            promptHint: "shot on a toy camera like a Holga or Lomo, heavy vignetting with light leaks, soft plastic-lens focus, lo-fi vintage character, and unpredictable color shifts", term: "holga toy camera" },
  { id: "tintype-wet-plate",      label: "Tintype / Wet Plate",   description: "Vintage wet-plate collodion",                promptHint: "vintage tintype wet-plate collodion photograph, silver-mirror tonality with ethereal blur on edges, sepia-leaning monochrome, slow-exposure stillness, and antique surface character", term: "tintype wet-plate collodion" },
  ...
  { id: "security-cam",           label: "Security Cam (CCTV)",   description: "CCTV fisheye + timestamp overlay",           promptHint: "CCTV security-camera footage, wide-angle fisheye distortion with visible timestamp overlay in the corner, low resolution monochrome or desaturated color, static interference lines, tracking artifacts, and surveillance-grade compression", term: "cctv security camera footage" },
  { id: "bw-film",                label: "B&W Film",              description: "Black and white film stock",                 promptHint: "shot on black and white film, rich grayscale tonality with classic film grain", term: "black and white film" },
  { id: "iphone",                 label: "iPhone",                description: "Modern phone-camera look",                   promptHint: "shot on a modern iPhone, computational image processing with sharp clarity, slight HDR look, and characteristic phone-camera color science", term: "iphone camera footage" },
] as const
...
export function getCameraFormatTerm(id: string | undefined | null): string {
  return resolveTerm(getCameraFormat(id))
}
