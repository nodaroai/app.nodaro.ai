...
export const STYLINGS: ReadonlyArray<Styling> = [
  // -------------------- Makeup --------------------
  { id: "makeup-natural",   label: "Natural",       dimension: "makeup",     description: "Subtle, no-makeup makeup",  promptHint: "with natural, subtle no-makeup makeup", term: "natural no-makeup makeup" },
  { id: "makeup-glamour",   label: "Glamour",       dimension: "makeup",     description: "Full polished glam look",   promptHint: "with full glamour makeup, polished and editorial", term: "full glamour makeup" },
  ...
  { id: "eyewear-aviators",        label: "Aviators",        dimension: "eyewear", description: "Classic aviator shades",  promptHint: "wearing classic aviator sunglasses with a metal frame", term: "aviator sunglasses" },
  { id: "eyewear-cat-eye",         label: "Cat-Eye",         dimension: "eyewear", description: "Vintage cat-eye frames",  promptHint: "wearing cat-eye glasses with vintage upswept frames", term: "cat-eye glasses" },
  { id: "eyewear-round",           label: "Round / John Lennon", dimension: "eyewear", description: "Round wire-frame glasses", promptHint: "wearing round wire-frame glasses, John Lennon style", term: "round wire-frame glasses" },
  ...
  { id: "eyewear-sport",           label: "Sport Goggles",   dimension: "eyewear", description: "Wraparound sport eyewear", promptHint: "wearing wraparound sport sunglasses", term: "wraparound sport sunglasses" },
  ...
  { id: "headwear-hood",         label: "Hood",          dimension: "headwear", description: "Hooded sweatshirt up",    promptHint: "with a hood pulled up over the head", term: "hood pulled up" },
  ...
  // ---- Short cuts ----
  { id: "cut-pixie",           label: "Pixie",           dimension: "hair-cut", description: "Short, cropped pixie cut",         promptHint: "styled in a short pixie cut", term: "pixie cut" },
  ...
  { id: "cut-shaved",          label: "Shaved",          dimension: "hair-cut", description: "Fully shaved",                     promptHint: "shaved bald", term: "shaved head" },
  ...
  { id: "cut-short",           label: "Short",           dimension: "hair-cut", description: "Generic short cut",                promptHint: "cut short", term: "short haircut" },
  ...
  { id: "cut-bob",             label: "Bob",             dimension: "hair-cut", description: "Chin-length bob cut",              promptHint: "styled in a chin-length bob cut", term: "bob cut" },
  { id: "cut-lob",             label: "Lob",             dimension: "hair-cut", description: "Long bob, collarbone-length",      promptHint: "styled in a long bob falling to the collarbone", term: "long bob" },
  ...
  { id: "cut-side-swept",      label: "Side-Swept",      dimension: "hair-cut", description: "Falls across face over one eye",   promptHint: "side-swept across the face with strands falling over one eye", term: "side-swept hair" },

  // ---- Pulled back / updos ----
  { id: "cut-slicked-back",    label: "Slicked Back",    dimension: "hair-cut", description: "Pulled straight back, polished",   promptHint: "slicked straight back with a polished finish", term: "slicked-back hair" },
  { id: "cut-bardot-tendrils", label: "Bardot Tendrils", dimension: "hair-cut", description: "Pulled back with face-framing strands", promptHint: "pulled back with thin face-framing tendrils falling loose at the temples", term: "pulled back with face-framing tendrils" },
  { id: "cut-ponytail",        label: "Ponytail (Low)",  dimension: "hair-cut", description: "Low pulled-back ponytail",         promptHint: "in a low pulled-back ponytail", term: "low ponytail" },
  ...
  { id: "cut-bun",             label: "Bun",             dimension: "hair-cut", description: "Classic low or mid bun",           promptHint: "in a bun", term: "hair bun" },
  ...
  { id: "cut-two-braids",      label: "Two Braids",      dimension: "hair-cut", description: "Pigtail braids either side",       promptHint: "in two pigtail braids", term: "pigtail braids" },
  ...
  { id: "hair-wet",         label: "Wet",          dimension: "hair-state", description: "Soaked, water-clinging hair",  promptHint: "with hair soaked and wet, strands clinging together and dripping water", term: "wet hair" },
  { id: "hair-damp",        label: "Damp",         dimension: "hair-state", description: "Just-washed damp hair",        promptHint: "with hair freshly damp, slightly weighted and softly clumped", term: "damp hair" },
  { id: "hair-messy",       label: "Messy",        dimension: "hair-state", description: "Disheveled, unkempt",          promptHint: "with hair messy and disheveled, unkempt strands going every direction", term: "messy hair" },
  { id: "hair-tousled",     label: "Tousled",      dimension: "hair-state", description: "Lightly mussed, lived-in",     promptHint: "with hair softly tousled and lived-in, casual undone movement", term: "tousled hair" },
  { id: "hair-bedhead",     label: "Bedhead",      dimension: "hair-state", description: "Just-woken-up flattened side", promptHint: "with bedhead — hair flattened on one side, fluffed on the other, like just woken up", term: "bedhead hair" },
  { id: "hair-windswept",   label: "Windswept",    dimension: "hair-state", description: "Wind-blown, hair in motion",   promptHint: "with hair caught mid-motion in wind, strands streaming sideways across and away from the face", term: "windswept hair" },
  { id: "hair-voluminous",  label: "Voluminous",   dimension: "hair-state", description: "Big, blown-out volume",        promptHint: "with hair full of volume, blown out and bouncy with body and lift at the roots", term: "voluminous blown-out hair" },
  { id: "hair-sleek",       label: "Sleek",        dimension: "hair-state", description: "Glassy smooth straight",       promptHint: "with hair sleek and glass-smooth, every strand pressed flat with a polished sheen", term: "sleek straight hair" },
  { id: "hair-frizzy",      label: "Frizzy",       dimension: "hair-state", description: "Halo of frizz",                promptHint: "with hair frizzy, fine flyaway strands forming a soft halo around the head", term: "frizzy hair" },
  { id: "hair-strands-on-face", label: "Strands on Face", dimension: "hair-state", description: "Loose strands across face", promptHint: "with loose hair strands falling across the face, partially covering one eye", term: "loose strands across the face" },
  { id: "hair-tucked-behind-ear", label: "Tucked Behind Ear", dimension: "hair-state", description: "Pushed behind one ear", promptHint: "with hair pushed back and tucked behind one ear, exposing the side of the face", term: "hair tucked behind one ear" },
  { id: "hair-flowing",     label: "Flowing",      dimension: "hair-state", description: "Long flowing motion",          promptHint: "with hair flowing freely, strands cascading and rippling with subtle movement", term: "flowing hair" },
  ...
  { id: "treatment-highlights",  label: "Highlights",    dimension: "hair-treatment", description: "Classic foil highlights",         promptHint: "with highlights — lighter streaks throughout the hair", term: "hair highlights" },
  { id: "treatment-lowlights",   label: "Lowlights",     dimension: "hair-treatment", description: "Darker shade streaks",            promptHint: "with lowlights — darker streaks woven through for dimension", term: "hair lowlights" },
  { id: "treatment-rooted",      label: "Rooted",        dimension: "hair-treatment", description: "Visible root regrowth look",      promptHint: "with a rooted look — visible darker roots blending into lighter lengths", term: "rooted color with dark roots" },

  // -------------------- Jewelry --------------------
  { id: "jewelry-subtle",     label: "Subtle",     dimension: "jewelry", description: "Minimal, delicate jewelry", promptHint: "wearing subtle, minimal jewelry", term: "delicate minimal jewelry" },
  { id: "jewelry-statement",  label: "Statement",  dimension: "jewelry", description: "Bold statement piece",      promptHint: "wearing a bold statement jewelry piece", term: "statement jewelry" },
  { id: "jewelry-gold",       label: "Gold",       dimension: "jewelry", description: "Gold necklace + earrings",  promptHint: "wearing gold jewelry — a necklace and earrings", term: "gold jewelry" },
  { id: "jewelry-silver",     label: "Silver",     dimension: "jewelry", description: "Silver necklace + earrings", promptHint: "wearing silver jewelry — a necklace and earrings", term: "silver jewelry" },
  { id: "jewelry-layered",    label: "Layered",    dimension: "jewelry", description: "Layered necklaces / chains", promptHint: "wearing layered necklaces of varying lengths", term: "layered necklaces" },
  ...
  { id: "nails-red",          label: "Red",          dimension: "nails", description: "Bright red nail polish",       promptHint: "with bright red nail polish", term: "red nail polish" },
  { id: "nails-dark",         label: "Dark",         dimension: "nails", description: "Dark / black nails",           promptHint: "with dark black nail polish", term: "black nail polish" },
  { id: "nails-long-acrylic", label: "Long Acrylic", dimension: "nails", description: "Long acrylic nails",           promptHint: "with long acrylic nails", term: "long acrylic nails" },
  { id: "nails-french",       label: "French Tips",  dimension: "nails", description: "Classic French manicure",      promptHint: "with classic French tip manicure", term: "french tip manicure" },
  ...
  { id: "face-paint-costume",  label: "Costume Paint",     dimension: "face-paint", description: "Cosplay / theatrical paint",       promptHint: "with theatrical costume face paint", term: "theatrical costume face paint" },
  ...
  { id: "fabric-lace",     label: "Lace",     dimension: "fabric", description: "Delicate patterned lace",       promptHint: "wearing delicate patterned lace with intricate floral openwork", term: "delicate patterned lace" },
  ...
  { id: "outfit-sundress",         label: "Sundress / Maxi",  dimension: "outfit", description: "Flowy halter-neck sundress / patterned maxi", promptHint: "dressed in a flowy halter-neck sundress with a patterned maxi-length skirt", term: "flowy maxi sundress" },
  ...
  { id: "outfit-flapper",          label: "1920s Flapper",    dimension: "outfit", description: "Beaded flapper dress",              promptHint: "dressed in a 1920s flapper dress — beaded fringe and a low-drop hem", term: "1920s flapper dress" },
  { id: "outfit-goth",             label: "Goth",             dimension: "outfit", description: "Full dark goth: black lace, leather, dark makeup, chains", promptHint: "wearing a full goth outfit — black lace and leather layered together, chains and silver hardware, with dark dramatic makeup", term: "goth outfit" },
  { id: "outfit-emo",              label: "Emo",              dimension: "outfit", description: "Early-2000s emo: skinny jeans, band tee, dyed hair, eyeliner", promptHint: "wearing an early-2000s emo outfit — skinny black jeans and a band tee, with dyed side-swept hair and heavy eyeliner", term: "emo outfit" },
  ...
  { id: "outfit-cyberpunk",        label: "Cyberpunk",        dimension: "outfit", description: "Neon-lit cyberpunk: tech wear, LED accents, mesh layers", promptHint: "wearing a cyberpunk outfit — neon-lit techwear with LED accents, mesh layers, and a futuristic urban silhouette", term: "cyberpunk techwear outfit" },
  { id: "outfit-cottagecore",      label: "Cottagecore",      dimension: "outfit", description: "Pastoral cottage aesthetic: prairie dress, apron, basket", promptHint: "wearing a cottagecore outfit — a long pastoral prairie dress with an apron and a woven basket on the arm", term: "cottagecore prairie dress" },
  { id: "outfit-dark-academia",    label: "Dark Academia",    dimension: "outfit", description: "Oxford-tweed scholar: blazer, vest, oxford shoes, books", promptHint: "wearing a dark academia outfit — a tweed blazer over a knit vest, oxford shoes, with books tucked under the arm", term: "dark academia outfit" },
  ...
  { id: "outfit-nurse",            label: "Nurse",            dimension: "outfit", description: "Medical scrubs, stethoscope, lanyard ID", promptHint: "dressed as a nurse — fitted medical scrubs with a stethoscope around the neck and a lanyard ID badge", term: "nurse uniform with stethoscope" },
  { id: "outfit-pirate",           label: "Pirate",           dimension: "outfit", description: "Pirate costume: tricorn hat, sash, frilly shirt, boots", promptHint: "wearing a pirate costume — a tricorn hat, a frilly shirt with a sash at the waist, and tall leather boots", term: "pirate costume" },
  ...
  { id: "top-button-down",   label: "Button-Down",    dimension: "top", description: "Tailored button-down shirt",     promptHint: "wearing a tailored button-down shirt with a sharp pointed collar", term: "button-down shirt" },
  ...
  { id: "footwear-mules",           label: "Mules",            dimension: "footwear", description: "Backless slip-on mules",   promptHint: "in slip-on backless mules", term: "backless slip-on mules" },
  ...
  { id: "footwear-crocs",           label: "Crocs",            dimension: "footwear", description: "Colorful resin clogs, casual and divisive", promptHint: "in colorful resin Crocs clogs with the signature perforated upper", term: "crocs resin clogs" },
  ...
  { id: "footwear-converse",        label: "Converse",         dimension: "footwear", description: "Canvas high-top sneakers, classic Chuck Taylor", promptHint: "in classic Converse Chuck Taylor canvas high-top sneakers with a rubber toe cap", term: "converse chuck taylor sneakers" },
  { id: "footwear-vans",            label: "Vans",             dimension: "footwear", description: "Slip-on or low-top skater sneakers", promptHint: "in classic Vans skater sneakers with the signature waffle sole", term: "vans skater sneakers" },
 ...
 * mechanism clause.
 */
export function getStylingTerm(id: string | undefined | null): string {
  return resolveTerm(getStyling(id))
}

export const STYLING_IDS: ReadonlyArray<string> = STYLINGS.map((s) => s.id)

/**
 * The one walk BOTH `buildStylingHints` (verbose) and `buildStylingTerms`
 * (compact) delegate to: free-text pre-field, every dimension in canonical
 * order, free-text post-field. `fragmentFor` is the only difference between
 * the two modes, so they can never disagree about WHICH ids contribute or in
 * what order — only about how each one is phrased.
 */
function collectStylingFragments(
 ...
 */
export function buildStylingTerms(
  data: Record<string, unknown> & StylingValue,
): string[] {
  return collectStylingFragments(data, getStylingTerm)
}
