...
export const COLOR_LOOKS: ReadonlyArray<ColorLook> = [
  // Palette (13)
  { id: "warm",            label: "Warm",            category: "palette", description: "Warm orange/red tones",          promptHint: "warm color palette, orange and red tones throughout the image with golden highlights", term: "warm color grade" },
  { id: "cool",            label: "Cool",            category: "palette", description: "Cool blue/teal tones",            promptHint: "cool color palette, blue and teal tones throughout the image with subdued warm accents", term: "cool color grade" },
  { id: "teal-orange",     label: "Teal & Orange",   category: "palette", description: "Hollywood complementary grade",   promptHint: "teal and orange color grade, warm skin tones against cool teal shadows, Hollywood blockbuster look", term: "teal and orange grade" },
  ...
  { id: "faded-matte",     label: "Faded Matte",     category: "palette", description: "Lifted blacks, milky low-contrast", promptHint: "faded matte color grade, lifted blacks and milky low-contrast shadows with soft hazy highlights, flat Instagram-soft aesthetic with reduced dynamic range", term: "faded matte grade" },
  { id: "log-flat",        label: "Log Flat",        category: "palette", description: "Pre-grade S-Log/V-Log neutral",   promptHint: "log-flat ungraded footage look, washed-out neutral S-Log or V-Log appearance with low contrast and desaturated muddy mids before any creative color grading is applied", term: "flat ungraded log footage" },
  { id: "desaturated",     label: "Desaturated",     category: "palette", description: "Low saturation, muted",           promptHint: "desaturated color grading, muted low-saturation tones throughout, almost monochromatic feel", term: "desaturated color grade" },
  { id: "monochrome-bw",   label: "Monochrome B&W",  category: "palette", description: "Pure black and white",            promptHint: "monochrome black and white, pure grayscale image with no color information", term: "black and white" },
  { id: "sepia",           label: "Sepia",           category: "palette", description: "Vintage brown tone",              promptHint: "sepia toned image, warm brown vintage monochrome with classic photographic feel", term: "sepia tone" },
  { id: "pastel",          label: "Pastel",          category: "palette", description: "Soft, low-contrast pastels",      promptHint: "pastel color palette, soft low-contrast pastel hues with light airy tones", term: "pastel color palette" },
  { id: "high-contrast",   label: "High Contrast",   category: "palette", description: "Punchy contrast, deep blacks",   promptHint: "high contrast color grade, punchy saturated colors with crushed deep blacks and bright highlights", term: "high contrast color grade" },
  { id: "vibrant",         label: "Vibrant",         category: "palette", description: "Highly saturated colors",         promptHint: "vibrant saturated color palette, bold rich colors with high saturation throughout", term: "vibrant saturated color palette" },
  ...
  { id: "technicolor",     label: "Technicolor 3-strip", category: "film-emulation", description: "Vivid retro Technicolor",  promptHint: "Technicolor 3-strip emulation, vivid saturated red/green/blue color separation with classic Hollywood golden-age look", term: "three-strip technicolor" },
  ...
  { id: "hand-tinted",     label: "Hand-Tinted",     category: "film-emulation", description: "B&W with hand-painted color",  promptHint: "hand-tinted photograph aesthetic, base black-and-white image with hand-painted color accents applied selectively to lips, cheeks, garments and props, painterly translucent washes of pigment over the monochrome plate", term: "hand-tinted black-and-white photograph" },
  { id: "agfa-orwo",       label: "Agfa / ORWO",     category: "film-emulation", description: "Eastern European cool greens", promptHint: "Agfa or ORWO film stock emulation, Eastern European film with cool muted greens, amber-leaning skin tones, slightly desaturated mids and a distinctive socialist-era documentary feel", term: "orwo film stock" },
  { id: "day-for-night",   label: "Day-for-Night",   category: "film-emulation", description: "Daylight graded as night",     promptHint: "day-for-night color grading, daylight footage graded with deep blue tones and crushed shadows to simulate moonlit night", term: "day-for-night grade" },
  { id: "cross-processed", label: "Cross-Processed", category: "film-emulation", description: "Color shifts from xpro",        promptHint: "cross-processed film look, slide film developed in print chemistry causing surreal color shifts and pushed contrast", term: "cross-processed film look" },
  ...
  { id: "expired-film",    label: "Expired Film / Light-struck", category: "film-emulation", description: "Color shifts and light leaks", promptHint: "expired film and light-struck aesthetic, unpredictable color shifts with overexposed magenta and amber casts, visible light leaks and fogged edges, found-film degradation feel with elevated grain and unstable shifting hues", term: "expired light-struck film" },

  // Social-preset (modern social-video aesthetics — distinct from analog film emulations)
  { id: "instagram-warm",     label: "Instagram Warm",     category: "social-preset", description: "Valencia-style warm filter",   promptHint: "Instagram-style warm filter aesthetic, slightly faded warm highlights with creamy mid-tones, Valencia-preset feel", term: "warm instagram filter" },
  { id: "tiktok-saturated",   label: "TikTok Saturated",   category: "social-preset", description: "Bright punchy social palette", promptHint: "TikTok-style oversaturated bright palette, punchy reds and blues with high contrast and vivid skin tones", term: "saturated tiktok look" },
  { id: "youtube-vlog-flat",  label: "YouTube Vlog Flat",  category: "social-preset", description: "Clean vlog flat grade",        promptHint: "YouTube vlog clean flat color grade, neutral natural color rendition with even skin tones and pleasant ambient", term: "flat youtube vlog grade" },
  ...
  { id: "y2k-saturated",      label: "Y2K Saturated",      category: "social-preset", description: "Early-2000s digital pop",      promptHint: "Y2K early-2000s digital saturation aesthetic, electric magenta and cyan punch, glossy compact-camera color, candy-bright primaries with a slightly crunchy CCD-sensor digital sharpness", term: "saturated y2k digital color" },
  { id: "mtv-90s-vhs",        label: "MTV 90s VHS",        category: "social-preset", description: "Oversaturated 90s VHS chroma", promptHint: "MTV 1990s VHS aesthetic, oversaturated cast with chroma bleed and color smearing, blown-out reds and electric blues, lo-fi tape-era saturation distinct from cleaner film emulations", term: "90s mtv vhs look" },
  { id: "polaroid-faded",     label: "Polaroid Faded",     category: "social-preset", description: "Magenta-tinted faded Polaroid", promptHint: "faded vintage Polaroid aesthetic, washed-out magenta and pink color cast, lifted milky shadows, yellowed highlights and the soft instant-film degradation of an aged SX-70 print, distinct from Kodak Portra negative-film emulation", term: "faded polaroid look" },
  { id: "lifestyle-warm-magazine", label: "Lifestyle Warm Magazine", category: "social-preset", description: "Modern warm editorial grade", promptHint: "modern lifestyle magazine warm-leaning grade, creamy honeyed highlights, gently warmed skin tones, soft golden mids and clean neutral shadows, contemporary editorial commercial aesthetic for fashion and food photography", term: "warm lifestyle magazine grade" },
] as const
...
export function getColorLookTerm(id: string | undefined | null): string {
  return resolveTerm(getColorLook(id))
}
