...
export const LENSES: ReadonlyArray<Lens> = [
  ...
  { id: "anamorphic",            label: "Anamorphic",              description: "Cinematic widescreen, oval bokeh",            promptHint: "anamorphic lens look, characteristic oval bokeh and horizontal lens flares", term: "anamorphic lens" },
  { id: "macro",                 label: "Macro",                   description: "Extreme close-up of small detail",            promptHint: "macro lens, capable of extreme close focus and life-size magnification with a very shallow depth of field", term: "macro lens" },
