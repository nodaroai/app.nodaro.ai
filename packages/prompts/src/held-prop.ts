...
export interface HeldProp {
   ...
   * where the lowercased label alone would inject the wrong prop, or a thinner
   * one than the entry is about: homonym traps ("Lighter", "Joint", "Compass",
   * "Marker", "Notebook", "Drumsticks", "Apple"), UI-shaped labels (e.g.
   * "Phone Raised", "Single Rose"), labels whose trade meaning collides with a
   * sibling entry ("Cocktail Glass" is the conical glass in the trade; this
   * entry is a rocks glass), and labels that drop the qualifier deciding what
   * actually RENDERS — a state, or the specific material / color the entry
   * describes (e.g. "Cigarette" -> lit cigarette, "Umbrella" -> open black
   * umbrella, "Book" -> open hardback book). Left derived where the lowercased
   * label already IS the whole prop and the description adds only finish or
   * flourish (e.g. "Smartphone", "Coffee Cup", "Handbag", "Gavel").
   */
...
export const HELD_PROPS: ReadonlyArray<HeldProp> = [
  ...
  { id: "smartphone-raised",  label: "Phone Raised",       category: "device",          description: "Phone raised mid-photo",            promptHint: "holding a smartphone raised at arm's length toward the camera as if mid-photo, both the phone and the gesture clearly visible", term: "smartphone raised at arm's length" },
  ...
  { id: "vintage-camera",     label: "Vintage Camera",     category: "device",          description: "Old film camera with strap",        promptHint: "holding a vintage 35mm film camera lifted toward the face with a leather strap looped around the neck, fingers poised over the shutter", term: "vintage 35mm film camera" },
  ...
  { id: "video-camera",       label: "Video Camera",       category: "device",          description: "Shoulder-mounted video camera",     promptHint: "shouldering a professional video camera with one hand on the side grip and the other steadying the body, eye to the viewfinder", term: "shoulder-mounted video camera" },
  { id: "microphone",         label: "Microphone",         category: "device",          description: "Handheld vocal microphone",         promptHint: "gripping a handheld microphone close to the lips with one hand, the cable looping down from the bottom", term: "handheld vocal microphone" },
  ...
  { id: "takeaway-coffee",    label: "Takeaway Coffee",    category: "drink",           description: "Paper takeaway coffee cup",         promptHint: "holding a paper takeaway coffee cup with a sleeve and lid in one hand, steam drifting from the small opening", term: "paper takeaway coffee cup" },
  { id: "wine-glass",         label: "Wine Glass",         category: "drink",           description: "Stemmed glass of red wine",         promptHint: "holding a stemmed wine glass by the bowl, deep red wine catching the warm ambient light", term: "stemmed glass of red wine" },
  ...
  { id: "cocktail-glass",     label: "Cocktail Glass",     category: "drink",           description: "Short glass with cocktail",         promptHint: "holding a short rocks glass with an amber cocktail and a single ice sphere, two fingers pressed against the chilled side", term: "rocks glass with an amber cocktail" },
  { id: "beer-bottle",        label: "Beer Bottle",        category: "drink",           description: "Brown bottle of beer",              promptHint: "holding a brown glass beer bottle loosely by the neck, condensation beading on the surface", term: "brown glass beer bottle" },
  ...
  // -------------------- Smoking --------------------
  { id: "cigarette",          label: "Cigarette",          category: "smoking",         description: "Lit cigarette between fingers",     promptHint: "holding a lit cigarette pinched between two fingers raised near the face, a thin curl of smoke drifting upward", term: "lit cigarette" },
  { id: "cigar",              label: "Cigar",              category: "smoking",         description: "Thick lit cigar",                   promptHint: "holding a thick lit cigar between two fingers, a slow wisp of smoke rising and an ember glowing at the tip", term: "lit cigar" },
  ...
  { id: "joint",              label: "Joint",              category: "smoking",         description: "Hand-rolled joint",                 promptHint: "holding a hand-rolled joint pinched between thumb and forefinger, a thin trail of smoke rising into the frame", term: "hand-rolled joint" },
  { id: "lighter",            label: "Lighter",            category: "smoking",         description: "Chrome lighter with thumb on flame", promptHint: "holding a polished chrome lighter cupped in one hand with the thumb pressed on the wheel, a small warm flame catching across the fingers", term: "lit chrome lighter" },

  // -------------------- Reading / Writing --------------------
  { id: "book",               label: "Book",               category: "reading-writing", description: "Open hardback book",                promptHint: "holding an open hardback book in both hands at chest height, eyes drifting down toward the page", term: "open hardback book" },
  { id: "magazine",           label: "Magazine",           category: "reading-writing", description: "Glossy folded magazine",            promptHint: "holding a glossy magazine folded back on itself in one hand, the cover partly visible from the side", term: "glossy folded magazine" },
  { id: "newspaper",          label: "Newspaper",          category: "reading-writing", description: "Folded broadsheet newspaper",       promptHint: "holding a folded broadsheet newspaper open between both hands at chest height, masthead lightly visible", term: "folded broadsheet newspaper" },
  { id: "notebook",           label: "Notebook",           category: "reading-writing", description: "Open lined notebook",               promptHint: "holding an open lined notebook in one hand at chest height with a pen poised above the page in the other", term: "open lined notebook" },
  ...
  { id: "marker",             label: "Marker",             category: "reading-writing", description: "Thick marker mid-stroke",           promptHint: "holding a thick permanent marker in one hand, cap clenched in the teeth and the tip poised mid-stroke", term: "thick permanent marker" },
  ...
  { id: "chalk",              label: "Chalk",              category: "reading-writing", description: "White stick of chalk",              promptHint: "holding a short stick of white chalk between thumb and forefinger, faint chalk dust drifting from the tip as if mid-stroke", term: "stick of white chalk" },
  ...
  { id: "tote-bag",           label: "Tote Bag",           category: "bag-accessory",   description: "Soft canvas tote",                  promptHint: "carrying a soft canvas tote bag slung over one shoulder, fabric folding naturally against the side", term: "soft canvas tote bag" },
  { id: "briefcase",          label: "Briefcase",          category: "bag-accessory",   description: "Hard-shell briefcase",              promptHint: "carrying a hard-shell briefcase by the top handle in one hand at hip height, the case angled to read clearly in frame", term: "hard-shell briefcase" },
  { id: "umbrella",           label: "Umbrella",           category: "bag-accessory",   description: "Open black umbrella",               promptHint: "holding an open black umbrella overhead with one hand, the canopy haloing the head and shadow falling across the face", term: "open black umbrella" },
  ...
  { id: "locket",             label: "Locket",             category: "bag-accessory",   description: "Open vintage locket pendant",       promptHint: "holding an open vintage locket pendant between thumb and forefinger close to the chest, the tiny portrait inside angled gently toward the face", term: "open vintage locket" },
  ...
  { id: "single-rose",        label: "Single Rose",        category: "floral-nature",   description: "Single long-stem rose",             promptHint: "holding a single long-stem red rose loosely between two fingers, the bloom raised softly toward the face", term: "long-stem red rose" },
  ...
  { id: "leaf",               label: "Leaf",               category: "floral-nature",   description: "Single large leaf",                 promptHint: "holding a single large green leaf by its stem in one hand, the broad surface positioned to one side of the face", term: "large green leaf" },
  { id: "fruit-apple",        label: "Apple",              category: "floral-nature",   description: "Single fresh apple",                promptHint: "holding a single fresh apple cradled in one open palm at chest height, the glossy skin catching the light", term: "fresh apple" },
  ...
  { id: "drumsticks",         label: "Drumsticks",         category: "instrument",      description: "Pair of drumsticks crossed",        promptHint: "holding a pair of drumsticks crossed in front of the chest, fingers wrapped firmly around their grips", term: "pair of wooden drumsticks" },
  ...
  { id: "pointer-stick",      label: "Pointer Stick",      category: "occupational",    description: "Telescoping pointer stick",         promptHint: "holding a slender telescoping pointer stick in one hand, the tip raised toward an unseen surface as if mid-explanation", term: "telescoping pointer stick" },
  ...
  { id: "lantern",            label: "Lantern",            category: "occupational",    description: "Vintage handheld lantern with amber glow", promptHint: "carrying a vintage handheld lantern by its top ring at hip height, warm amber glow casting a soft circular pool of light across the face and surroundings", term: "vintage handheld lantern" },
  ...
  { id: "compass",            label: "Compass",            category: "occupational",    description: "Vintage handheld nautical compass", promptHint: "holding a vintage brass nautical compass open in one cupped palm at chest height, the needle clearly visible as the eyes drift down to read the bearing", term: "brass nautical compass" },
  { id: "bow-and-arrow",      label: "Bow and Arrow",      category: "occupational",    description: "Drawn archery bow with arrow nocked", promptHint: "holding an archery bow drawn at full tension with one hand on the grip and the other pulling the string back to the cheek, an arrow nocked and aimed forward", term: "archery bow drawn with nocked arrow" },
  { id: "shield",             label: "Shield",             category: "occupational",    description: "Handheld medieval shield",          promptHint: "holding a medieval shield raised across the body with one arm strapped through the back, the front face angled forward in a defensive stance", term: "medieval shield" },
] as const
...
/**
 * Compact professional TERM for an id — the short prop name a stylist would
 * write in a prompt ("lit chrome lighter", "brass nautical compass"), as
 * opposed to the pose-carrying paragraph in `promptHint`.
 *
 * Bare noun phrase, NOT the catalog's "holding a…" grammar: the derived
 * default is the lowercased label, so an authored term must read the same way
 * and let the consumer supply the held-in-hand framing.
 *
 ...
 * resolved to their short professional terms instead of their pose-carrying
 * paragraph hints.
 */
