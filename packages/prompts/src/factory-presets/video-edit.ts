...
export const VIDEO_TO_VIDEO_PRESETS: readonly FactoryPreset[] = [
  {
    ...
    group: "Restyle Looks",
    data: { provider: "wan", promptPrefix: "Restyle this video as a 2D cel-shaded anime: vibrant colors, clean linework, expressive cel shading. Preserve the original motion, composition, and timing.", negativePrompt: "photorealistic, blurry, distorted, flickering" },
  },
  {
    ...
    group: "Restyle Looks",
    data: { provider: "wan", promptPrefix: "Restyle as tactile stop-motion claymation with plasticine textures and subtle fingerprints. Keep the original motion and framing.", negativePrompt: "photorealistic, smooth, flickering" },
  },
  {
    ...
    group: "Restyle Looks",
    data: { provider: "wan", promptPrefix: "Restyle with a neon cyberpunk aesthetic: rain-slicked surfaces, glowing magenta and cyan lighting, moody atmosphere. Preserve the original motion.", negativePrompt: "daylight, flat lighting, blurry, distorted" },
  },
  {
    ...
    group: "Restyle Looks",
    data: { provider: "wan", promptPrefix: "Restyle as a moving oil painting with visible brushstrokes, rich impasto texture, and painterly color. Keep the original motion and composition.", negativePrompt: "photorealistic, flat, blurry, flickering" },
  },
  {
    ...
    group: "Restyle Looks",
    data: { provider: "wan", promptPrefix: "Restyle as a polished 3D animated film: soft global illumination, expressive characters, clean stylized surfaces. Preserve the original motion and timing.", negativePrompt: "photorealistic, lowres, distorted, flickering" },
  },
  {
    ...
    group: "Restyle Looks",
    data: { provider: "wan", promptPrefix: "Restyle as a flowing watercolor animation with soft washes, bleeding edges, and visible paper texture. Keep the original motion and composition.", negativePrompt: "photorealistic, harsh edges, blurry, flickering" },
  },
]
