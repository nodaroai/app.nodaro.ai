...
export const GENERATE_IMAGE_PRESETS: readonly FactoryPreset[] = [
  // ── Reference Sheet ──────────────────────────────────────────────────────
  {
    ...
    data: {
      ...
      promptSuffix: `Style: photorealistic, no illustration. Consistent face across every single panel. 8K, fine grain, cinematic color grading.`,
      negativePrompt:
  ...
  },
  {
    ...
    data: {
      ...
      promptSuffix: `Style: photorealistic, no illustration. Consistent identity across every single panel. 8K, fine grain, cinematic color grading.`,
      negativePrompt:
  ...
  },
  {
    ...
    data: {
      ...
      promptSuffix: `Style: photorealistic, no illustration. Consistent location across every panel. 8K, fine grain, cinematic color grading.`,
      negativePrompt:
        "illustration, cartoon, 3d render, garbled text, misspelled labels, watermark, deformed faces, blurry, low resolution",
    },
  },
  {
    ...
    data: {
      ...
      promptSuffix: `Style: photorealistic, no illustration. Consistent product across every panel. 8K, fine grain, studio product photography, crisp reflections.`,
      negativePrompt:
        "illustration, cartoon, 3d render, garbled text, misspelled labels, watermark, deformed faces, blurry, low resolution",
    },
  },
  {
    ...
    data: {
      ...
      promptSuffix: `Style: photorealistic, no illustration. Consistent outfit across every panel. 8K, fine grain, editorial fashion photography.`,
      negativePrompt:
        "illustration, cartoon, 3d render, garbled text, misspelled labels, watermark, deformed faces, blurry, low resolution",
    },
  },
  {
    ...
    data: {
      ...
      promptSuffix: `Style: photorealistic, no illustration. Consistent scene across every panel. 8K, fine grain, cinematic color grading.`,
      negativePrompt:
        "illustration, cartoon, 3d render, garbled text, misspelled labels, watermark, deformed faces, blurry, low resolution",
    },
  },
  {
    ...
    data: {
      ...
      promptSuffix: `Style: photorealistic, no illustration. Consistent creature across every panel. 8K, fine grain, cinematic color grading.`,
      negativePrompt:
        "illustration, cartoon, 3d render, garbled text, misspelled labels, watermark, deformed faces, blurry, low resolution",
    },
  },
  {
    ...
    data: {
      ...
      promptSuffix: `Style: photorealistic, no illustration. Consistent vehicle across every panel. 8K, fine grain, cinematic color grading.`,
      negativePrompt:
  ...
  },
  {
    ...
    data: {
      ...
      promptSuffix: `Style: photorealistic, no illustration. Consistent dish across every panel. 8K, fine grain, appetizing commercial color grading.`,
      negativePrompt:
  ...
  },
  {
    ...
    data: {
      ...
      promptSuffix: `Consistent mascot and consistent art style across every panel. 8K, fine grain, premium brand-design finish.`,
      negativePrompt:
  ...
  },
  {
    ...
    data: {
      ...
      promptSuffix: `Style: photorealistic, no illustration. Consistent animal across every single panel. 8K, fine grain, cinematic color grading.`,
      negativePrompt:
  ...
  // practical consistency; 4K so panel faces stay sharp when reused as refs.) ──
  {
    ...
    data: {
      ...
      promptSuffix: `Photorealistic, sharp focus, accurate natural skin texture, true-to-life color.`,
      negativePrompt:
  ...
  },
  {
    ...
    description: "Step 2 · connect the labeled sheet → type your change in the prompt (e.g. change \"drink 1\" to blue); the labels are removed from the result.",
    group: "Edit by Name",
    data: {
      provider: "gpt-image-2",
      quality: "high",
      promptPrefix: `This image has callout labels naming its elements (made with the Label Elements preset). Use the labels ONLY to locate elements, then produce a clean edited photo with NO labels. Apply the change described next, referring to elements by their labels:`,
      promptSuffix: `REMOVE every callout label, text box and leader line so none appear in the final image. Keep everything else exactly as it is.`,
      negativePrompt:
  ...
  },
  {
    ...
    data: {
      ...
      aspectRatio: "auto",
      resolution: "1K",
      promptPrefix: "remove persons faces from {image:1}, keep everything else the same",
      negativePrompt:
  ...
  },
  {
    ...
    data: {
      ...
      aspectRatio: "auto",
      resolution: "1K",
      promptPrefix: "make faces transparent in {image:1}, keep everything else the same",
      negativePrompt:
