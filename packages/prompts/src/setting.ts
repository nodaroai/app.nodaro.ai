...
export const SETTINGS: ReadonlyArray<Setting> = [
  ...
  { id: "kitchen",         label: "Kitchen",              category: "indoor",      description: "Warm home kitchen with morning light",   term: "home kitchen", promptHint: "set in a warm home kitchen with morning light, wood cabinets, a marble island with fresh produce and steam rising from a stovetop" },
  { id: "bathroom",        label: "Bathroom",             category: "indoor",      description: "Bright everyday home bathroom",          promptHint: "set in a bright everyday home bathroom with a tiled wall, a mirror and a towel on a hook", term: "home bathroom" },
  ...
  { id: "hospital",        label: "Hospital",             category: "indoor",      description: "Sterile hospital corridor",              term: "hospital corridor", promptHint: "set in a sterile hospital corridor with polished linoleum floors, fluorescent ceiling lights, stainless-steel gurneys and softly beeping medical equipment" },
  ...
  { id: "subway-car",      label: "Subway Car",           category: "indoor",      description: "Moving subway interior",                 term: "subway car interior", promptHint: "set inside a moving subway car with fluorescent strip lights, graffiti-scarred windows and empty blue plastic seats" },
  ...
  { id: "car-interior",    label: "Car Interior",         category: "indoor",      description: "Front seat of a parked car",             promptHint: "set in the front seat of a parked car, daylight through the side window", term: "parked car interior" },
  { id: "cathedral",       label: "Cathedral",            category: "indoor",      description: "Gothic cathedral interior",              term: "gothic cathedral interior", promptHint: "set in a vast gothic cathedral interior with vaulted stone ceilings, stained-glass kaleidoscopes and candlelit side chapels" },
  ...
  { id: "balcony",         label: "Balcony",              category: "indoor",      description: "Apartment balcony with urban view",      term: "apartment balcony", promptHint: "set on an apartment balcony with potted plants along the railing, a sweeping urban view beyond, soft daylight and a candid intimate atmosphere of a private outdoor pocket above the city" },
  ...
  { id: "music-studio",    label: "Music Studio",         category: "indoor",      description: "Recording studio with mics and foam",    term: "recording studio", promptHint: "set in a recording music studio with a vocal microphone on a boom arm, soundproof foam panels on the walls, a large mixing control board, monitor speakers and warm low task lighting" },
  { id: "conservatory",    label: "Conservatory",         category: "indoor",      description: "Glass greenhouse with tropical plants",  term: "conservatory greenhouse", promptHint: "set inside a glass-walled conservatory greenhouse with tropical plants, hanging ferns, terracotta pots, filtered sunlight pouring through the panes and a humid earthy atmosphere" },
  ...
  { id: "rooftop",         label: "Rooftop",              category: "urban",       description: "Rooftop terrace over skyline",           term: "rooftop terrace", promptHint: "set on a rooftop terrace overlooking a dense city skyline with string lights, distant car horns and hazy sunset light" },
  ...
  { id: "neon-alley",      label: "Neon Alley",           category: "urban",       description: "Rain-soaked neon alley",                 term: "rain-soaked neon-lit alley", promptHint: "set in a rain-soaked neon-lit alley in a Tokyo-style nightlife district with glowing kanji signs, steam vents and reflective puddles" },
  ...
  { id: "train-station",   label: "Train Station",        category: "urban",       description: "Platform with waiting train",            term: "train station platform", promptHint: "set on a long urban train station platform with polished steel rails, a waiting train with warmly lit windows, overhead station signs, drifting steam and the lonely echo of footsteps on stone" },
  ...
  { id: "western-canyon",  label: "Western Canyon",       category: "nature",      description: "Red-rock mesa with a winding river",     term: "southwestern red-rock canyon", promptHint: "set in a sweeping Southwestern canyon landscape with red sandstone mesas, a winding river cutting through the valley floor, cottonwood groves, open arid plains and the wide cinematic sky of a classic Western" },
  ...
  { id: "underwater",      label: "Underwater",           category: "fantastical", description: "Sunlit deep-ocean scene",                term: "deep-ocean underwater scene", promptHint: "set in a deep-ocean underwater scene with shafts of sunlight piercing blue-green water, drifting particles and dim coral shapes" },
  { id: "fantasy-castle",  label: "Fantasy Castle",       category: "fantastical", description: "Sprawling castle courtyard",             term: "fantasy castle courtyard", promptHint: "set in a sprawling fantasy castle courtyard with weathered stone walls, banners, torches in iron sconces and wrought-iron gates" },
  { id: "medieval-village", label: "Medieval Village",    category: "fantastical", description: "Cobblestone village square",             term: "medieval village square", promptHint: "set in a cobblestone medieval village square with timber-framed houses, smoking chimneys, a stone well, market stalls and warm amber lantern light" },
...
export function getSettingTerm(id: string | undefined | null): string {
  return resolveTerm(getSetting(id))
}
