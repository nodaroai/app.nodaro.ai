...
export const MOODS: ReadonlyArray<Mood> = [
  // -------------------- Positive --------------------
  { id: "happy",       label: "Happy",        category: "positive", description: "Warm, smiling happiness",     promptHint: "with a warm, happy expression and a genuine smile", term: "happy expression" },
  { id: "joyful",      label: "Joyful",       category: "positive", description: "Radiant, unrestrained joy",   promptHint: "with a radiant, joyful expression full of delight, the corners of the mouth rising uncontrollably, steps light", term: "radiant joyful expression" },
  { id: "relieved",    label: "Relieved",     category: "positive", description: "Tension releasing into calm", promptHint: "with a relieved expression, letting out a long breath, shoulders relaxing completely, a faint long-awaited smile", term: "relieved expression" },
  { id: "serene",      label: "Serene",       category: "positive", description: "Calm, peaceful contentment",  promptHint: "with a serene, peaceful expression and relaxed posture", term: "serene expression" },
  { id: "playful",     label: "Playful",      category: "positive", description: "Mischievous, playful energy", promptHint: "with a playful, mischievous expression and light energy", term: "playful expression" },
  ...
  { id: "loving",      label: "Loving",       category: "positive", description: "Tender, affectionate",        promptHint: "with a tender, loving expression", term: "tender, loving expression" },
  ...
  { id: "hopeful",     label: "Hopeful",      category: "positive", description: "Bright-eyed, optimistic",     promptHint: "with a hopeful expression, a soft slight smile and bright, expectant eyes", term: "hopeful expression" },

  // -------------------- Negative --------------------
  { id: "sad",         label: "Sad",          category: "negative", description: "Quietly sad, downcast",       promptHint: "with a quietly sad, downcast expression, head lowered, shoulders trembling slightly, eyes reddening", term: "sad, downcast expression" },
  { id: "angry",       label: "Angry",        category: "negative", description: "Clear anger, tension",        promptHint: "with an angry expression, furrowed brow and tight jaw, fists clenched, chest heaving", term: "angry expression" },
  { id: "afraid",      label: "Afraid",       category: "negative", description: "Frightened, wide-eyed",       promptHint: "with a frightened expression, wide eyes and tense posture", term: "fearful expression" },
  { id: "anxious",     label: "Anxious",      category: "negative", description: "Nervous, worried",            promptHint: "with an anxious, worried expression and restless tension, fingers tapping, eyes darting, breath quickening", term: "anxious, nervous expression" },
  { id: "melancholy",  label: "Melancholy",   category: "negative", description: "Wistful sadness",             promptHint: "with a melancholy, wistful expression lost in thought", term: "melancholic expression" },
  { id: "devastated",  label: "Devastated",   category: "negative", description: "Heartbroken grief",           promptHint: "with a devastated, heartbroken expression", term: "devastated, heartbroken expression" },
  { id: "grieving",    label: "Grieving",     category: "negative", description: "Deep grief, loss",            promptHint: "with a grieving expression of deep loss", term: "grief-stricken expression" },
  ...
  { id: "aloof",       label: "Aloof",        category: "negative", description: "Withdrawn, uninterested",     promptHint: "with an aloof, withdrawn expression and a gaze pointedly elsewhere", term: "aloof, detached expression" },
  { id: "vulnerable",  label: "Vulnerable",   category: "negative", description: "Exposed, defenseless",        promptHint: "with a vulnerable, exposed expression, eyes faintly tearful and shoulders soft", term: "vulnerable, exposed expression" },
  { id: "coy",         label: "Coy",          category: "negative", description: "Shy, downcast",               promptHint: "with a coy, shy expression, downcast eyes, a faint blush and lips lightly pressed", term: "coy, bashful expression" },
  { id: "bored",       label: "Bored",        category: "negative", description: "Disinterested, deadpan",      promptHint: "with a bored, disinterested expression and a slack, deadpan stare", term: "bored, deadpan expression" },
  ...
  { id: "thoughtful",  label: "Thoughtful",   category: "neutral",  description: "Deep in thought",             promptHint: "with a thoughtful, contemplative expression", term: "thoughtful, contemplative expression" },
  { id: "stoic",       label: "Stoic",        category: "neutral",  description: "Impassive, unreadable",       promptHint: "with a stoic, impassive expression revealing nothing", term: "stoic, impassive expression" },
  { id: "calm",        label: "Calm",         category: "neutral",  description: "Centered, unreactive",        promptHint: "with a calm, centered expression", term: "calm expression" },
  { id: "curious",     label: "Curious",      category: "neutral",  description: "Intrigued, alert",            promptHint: "with a curious, intrigued expression and alert eyes", term: "curious expression" },
  { id: "mysterious",  label: "Mysterious",   category: "neutral",  description: "Inscrutable, enigmatic",      promptHint: "with a mysterious, enigmatic expression hard to read", term: "mysterious, enigmatic expression" },
  { id: "dazed",       label: "Dazed",        category: "neutral",  description: "Dreamy, half-present",        promptHint: "with a dazed, dreamy expression, eyes slightly out of focus and only half-present", term: "dazed, dreamy expression" },
  { id: "sleepy",      label: "Sleepy",       category: "neutral",  description: "Drowsy, heavy-lidded",        promptHint: "with a sleepy, drowsy expression, heavy eyelids and a slow, soft blink", term: "sleepy expression" },
 ...
 * ("cocky smirk and aloof, detached expression"). The full-mode weave rebuilds
 * the "with a ... expression" template from labels; a term already carries its
 * own grammar, so compact just joins.
 */
