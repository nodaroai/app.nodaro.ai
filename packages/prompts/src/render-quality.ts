...
export const RENDER_QUALITIES: ReadonlyArray<RenderQuality> = [
  ...
  { id: "redshift",           label: "Redshift",          description: "Production GPU biased renderer", promptHint: "rendered in Redshift, production-quality GPU rendering with rich material response, controlled GI and film-grade depth", term: "redshift render" },
  ...
  { id: "aces",               label: "ACES",              description: "Cinema-grade ACES color management", promptHint: "graded through the ACES (Academy Color Encoding System) color management workflow, modern cinema-grade tonal response with consistent wide-gamut color rendering, filmic highlight rolloff and reference-quality color fidelity", term: "aces color space" },
  ...
  { id: "physically-based-rendering",    label: "PBR",                    description: "Physically-based materials",     promptHint: "physically-based rendering with energy-conserving materials, accurate metallic/roughness response and realistic Fresnel falloff", term: "physically-based rendering" },
  ...
  { id: "16k-megapixel",   label: "16K Megapixel",   description: "Insanely high-resolution detail",    promptHint: "16K megapixel-grade resolution, insanely high-resolution detail with surgically clean edges and microscopic surface fidelity", term: "16k resolution" },
  { id: "ultra-detailed",  label: "Ultra Detailed",  description: "Maximum micro-detail rendering",     promptHint: "ultra-detailed rendering with intricate micro-surface detail, fine pore-level fidelity and meticulously preserved fine structures", term: "ultra-detailed" },
  ...
  { id: "award-winning",   label: "Award Winning",   description: "Award-circuit caliber",              promptHint: "award-winning quality, award-circuit caliber image with editorial-grade composition, magazine-cover finish and signature visual authority", term: "award-winning" },
  ...
  { id: "denoised",            label: "Denoised",            description: "Clean noise-removed pristine rendering, no grain or speckle", promptHint: "clean denoised rendering with noise removed entirely, pristine smooth surfaces and zero grain or speckle across shadows and midtones", term: "denoised render" },
] as const
...
export function getRenderQualityTerm(id: string | undefined | null): string {
  return resolveTerm(getRenderQuality(id))
}
