...
export const STYLES: ReadonlyArray<Style> = [
  ...
  { id: "woodcut",         label: "Woodcut",          description: "Dürer-era relief print woodblock",         promptHint: "rendered as a woodcut relief print, bold stark black ink on cream paper with assertive carved lines, parallel hatching for tonal shading, high-contrast graphic shapes and the wiry expressive line-work of Dürer-era Northern Renaissance prints" },
