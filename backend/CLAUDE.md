...
| `gemini-3.8-flash` | Economy | chat-completions | efforts low/high (KIE) / none–high (direct); direct lane (Advanced mode); image-only modality caps (VA decision deferred, same rationale as 3.7); KIE output cap measured 16k+ (unlike 3.6/3.7's 8192 intersection) → `maxOutputTokens: 16384` |
