...
import { AI_AVATAR_RESERVE_IDS, AI_AVATAR_DURATION_BUCKETS, type AiAvatarEngine, type AiAvatarResolution, CREDIT_BASE_USD} from "@nodaro/shared"
import { AI_AVATAR_RATE_USD_PER_SEC, aiAvatarHoldCredits, aiAvatarUsdCost } from "../../../lib/pricing/ai-avatar-cost.js"
