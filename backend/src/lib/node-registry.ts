...
export const NODE_REGISTRY: NodeDescriptor[] = [
  ...
  { type: "voice-changer", label: "Voice Changer", category: "ai-audio", description: "Transform the voice in an audio recording to sound like a different speaker while preserving the original emotion and delivery.", outputType: "audio" },
