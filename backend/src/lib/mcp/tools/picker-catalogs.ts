    ...
    "get_picker_catalog",
    {
      ...
      inputSchema: {
        ...
        field: z
          .string()
          .optional()
          .describe("Return only this dimension field. Multi-dim pickers (person/styling/framing), and single-dim pickers with secondary parameters (transition and character-fx: position/duration/intensity; character-motion: position/pace)."),
      },
