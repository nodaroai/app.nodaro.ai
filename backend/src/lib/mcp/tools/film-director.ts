...
/**
 * Embedded fallback — verbatim copy of SKILL.md v1.0.7. The unit test
...
export const FILM_DIRECTOR_TOOL_DESCRIPTION =
  "REQUIRED FIRST STEP for any multi-shot cinematic video request. BEFORE " +
  "calling generate_video, generate_image, animate_image, create_workflow, " +
  "image_to_image, or any other generation tool — you MUST call this tool " +
  "FIRST when the user asks for: a trailer, short film, music video, reel, " +
  "commercial, ad, scene, story, or any video with characters, locations, or " +
  "more than one shot. Returns the 10-stage director workflow you MUST follow " +
  "to assemble an editable Nodaro workflow on the user's canvas. Do NOT plan " +
  "generation steps, do NOT call generation tools, do NOT make tool selections " +
  "until you have called this tool and received the workflow instructions. " +
  "Calling this tool is non-destructive, idempotent, and free of side effects. " +
  "If you are about to plan or call any generation tool for a video request, " +
