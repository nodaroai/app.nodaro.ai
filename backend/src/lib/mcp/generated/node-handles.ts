...
export const NODE_HANDLES: Readonly<Record<string, NodeHandleSpec>> = {
  ...
  "character": { inputs: ["assets", "in"], outputs: ["characterRef"] },
  ...
  "creature": { inputs: ["in", "type"], outputs: ["creatureRef"] },
  ...
  "location": { inputs: ["in", "cinematography"], outputs: ["locationRef"] },
  ...
  "object": { inputs: ["in", "type"], outputs: ["objectRef"] },
