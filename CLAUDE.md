...
*Last updated: 2026-05-16 (character mention usage modes + aspect-ratio defaults: added 6th mode `pose` (body pose only, no face transfer); strengthened identity-preservation directives across all modes; per-asset-type aspect-ratio defaults replace 16:9 default — portrait/headAngles/lighting=3:4, expressions=1:1, poses/bodyAngles/motions=9:16; character node 4-pill aspect toggle 1:1/3:4/16:9/9:16; body-angles framing changed from "T-pose" to "standing naturally with arms relaxed at sides"; character node gets default width 220px on creation.)*
*Version: 2.14.1*
