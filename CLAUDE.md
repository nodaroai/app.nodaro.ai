...
*Last updated: 2026-05-14 (sub-workflow v1: `parent_workflow_id` (migration 116) + editable fullscreen via route-nav + breadcrumb stack + view-mode plugin registry (Ports default) + boundary-pair validation + `POST /v1/workflows/:parentId/sub-workflows` create-child endpoint + Expand icon on sub-workflow node)*
*Version: 2.13.0*
