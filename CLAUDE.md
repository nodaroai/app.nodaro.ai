...
*Last updated: 2026-05-12 (KIE i2v image normalization: cap input frames at 2048px; re-encode Hailuo/MiniMax inputs to JPEG to avoid backend "internal error" on large RGBA PNGs; add isVeoProvider/VEO_PROVIDERS to shared)*
*Version: 2.8.1*
