...
--
--   sync-lipsync-v3  $0.13333/s  ($8/min)  (fal-ai/sync-lipsync/v3)
--
...
-- verbatim as the charge. The bare row is the back-compat default (300s ceiling)
...
VALUES
  ...
  ('sync-lipsync-v3:15s',    100, true, 'lip-sync'),  -- $2.00
  ('sync-lipsync-v3:30s',    200, true, 'lip-sync'),  -- $4.00
  ('sync-lipsync-v3:60s',    400, true, 'lip-sync'),  -- $8.00
  ('sync-lipsync-v3:120s',   800, true, 'lip-sync'),  -- $16.00
  ('sync-lipsync-v3:300s',  2000, true, 'lip-sync')   -- $40.00 — 5-min ceiling
