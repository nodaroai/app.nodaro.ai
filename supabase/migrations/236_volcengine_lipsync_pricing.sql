...
VALUES
  ('volcengine-lipsync',       600, true, 'lip-sync'),  -- bare = 300s ceiling
  ('volcengine-lipsync:15s',    30, true, 'lip-sync'),
  ('volcengine-lipsync:30s',    60, true, 'lip-sync'),
  ('volcengine-lipsync:60s',   120, true, 'lip-sync'),
  ('volcengine-lipsync:120s',  240, true, 'lip-sync'),
  ('volcengine-lipsync:300s',  600, true, 'lip-sync')   -- 5-min ceiling
