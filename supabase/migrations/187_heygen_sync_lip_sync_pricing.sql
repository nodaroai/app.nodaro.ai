...
VALUES
  ...
  ('heygen-lipsync-precision:15s',     51, true, 'lip-sync'),
  ('heygen-lipsync-precision:30s',    101, true, 'lip-sync'),
  ('heygen-lipsync-precision:60s',    201, true, 'lip-sync'),
  ('heygen-lipsync-precision:120s',   401, true, 'lip-sync'),
  ('heygen-lipsync-precision:300s',  1001, true, 'lip-sync'),  -- 5-min ceiling
  ('lipsync-2-pro',                  1249, true, 'lip-sync'),  -- bare = 300s ceiling
  ('lipsync-2-pro:15s',                63, true, 'lip-sync'),
  ('lipsync-2-pro:30s',               125, true, 'lip-sync'),
  ('lipsync-2-pro:60s',               250, true, 'lip-sync'),
  ('lipsync-2-pro:120s',              500, true, 'lip-sync'),
  ('lipsync-2-pro:300s',             1249, true, 'lip-sync')   -- 5-min ceiling
