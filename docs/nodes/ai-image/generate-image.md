...
Generate Image is the primary text-to-image node. It accepts a text prompt (with optional style presets, negative prompts, and reference images) and produces an image via one of 21 AI providers. Credit costs range from 1 to 8 depending on the selected provider and quality/resolution settings. The default provider is Nano Banana Pro at 16:9 aspect ratio.
...
Base costs vary by provider. Models with variable pricing use composite identifiers (e.g., `gpt-image:high`).

| Provider | Base Credits | Variable Credits | Variable Setting |
|----------|-------------|-----------------|------------------|
| z-image | 1 | -- | -- |
| nano-banana | 2 | -- | -- |
| flux | 2 | 3 | 2K resolution |
| grok | 2 | -- | -- |
| qwen | 2 | -- | -- |
| imagen4-fast | 2 | -- | -- |
| flux-kontext | 2 | -- | -- |
| seedream-5-lite | 2 | 5 | high (4K) quality |
| imagen4 | 3 | -- | -- |
| seedream | 3 | 4 | high (4K) quality |
| gpt-image | 4 | 7 | high quality |
| imagen4-ultra | 4 | -- | -- |
| flux-kontext-max | 4 | -- | -- |
| nano-banana-2 | 4 | 5 (2K), 7 (4K) | resolution |
| flux-flex | 5 | 8 | 2K resolution |
| nano-banana-pro | 6 | 8 | 4K resolution |
| ideogram-v3 | 2 (balanced) | 1 (turbo), 3 (quality) | rendering speed |
...
| ideogram-v3 | Ideogram V3 | Fast text-to-image, affordable | 1:1, 16:9, 9:16, 4:3, 3:4 |
...
- Use Nano Banana or Z-Image for rapid iteration and storyboarding due to low cost and fast speed.
...
- Resolution and quality settings have significant credit cost impact. Use 1K resolution and medium quality during iteration, then switch to higher settings for final output.
