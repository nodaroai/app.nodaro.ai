  ...
  return (
    <div className="mt-6 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-card p-6">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="text-base font-semibold">{t("consent.emailPreferences")}</h2>
      </div>
      <div className="flex items-center justify-between">
        <div className="pe-4">
          <Label htmlFor="marketing-email">{t("consent.productUpdateEmails")}</Label>
          <p className="text-xs text-muted-foreground mt-0.5">
            {t("consent.productUpdateEmailsHint")}
          </p>
        </div>
