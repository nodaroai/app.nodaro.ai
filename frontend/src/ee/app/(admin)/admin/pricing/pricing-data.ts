...
export const MODEL_REFERENCE: Readonly<Record<string, ModelReferenceData>> = {
  ...
  "seedance-2:8s:1080p":     { provider: "KIE.ai", providerCostUsd: 1.02, markupPct: 25 },  // 204 cr (8s, 1080p, no ref)
  "seedance-2:8s:1080p-ref": { provider: "KIE.ai", providerCostUsd: 0.62, markupPct: 25 },  // 124 cr (8s, 1080p, w/ref)
  "seedance-2:8s:4k":        { provider: "KIE.ai", providerCostUsd: 2.08, markupPct: 25 },  // 416 cr (8s, 4k, no ref)
  "seedance-2:8s:4k-ref":    { provider: "KIE.ai", providerCostUsd: 1.28, markupPct: 25 },  // 256 cr (8s, 4k, w/ref)
  "seedance-2-fast":   { provider: "KIE.ai",    providerCostUsd: 0.330, markupPct: 25 },  // 66 KIE cr avg (8s, 720p, no ref; per-sec; 480p/720p only — NO 1080p SKU)
  ...
  // Sync Lipsync v3 ($8/min = $0.13333/s) — fal.ai, per output second, billed
  // at cost (0% markup). Buckets 15/30/60/120/300s.
  "sync-lipsync-v3":               { provider: "fal.ai",    providerCostUsd: 40.0000, markupPct: 0 },  // bare = 300s ceiling
  "sync-lipsync-v3:15s":           { provider: "fal.ai",    providerCostUsd: 2.0000,  markupPct: 0 },
  "sync-lipsync-v3:30s":           { provider: "fal.ai",    providerCostUsd: 4.0000,  markupPct: 0 },
