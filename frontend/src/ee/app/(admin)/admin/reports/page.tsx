...
function getOutputUrl(jobType: string, outputData: Record<string, unknown> | null): string | null {
  ...
  const videoTypes = ["generate-video", "image-to-video", "text-to-video", "video-to-video", "lip-sync", "motion-transfer", "video-upscale", "combine-videos", "suno-music-video", "merge-video-audio", "resize-video", "trim-video", "add-captions"]
