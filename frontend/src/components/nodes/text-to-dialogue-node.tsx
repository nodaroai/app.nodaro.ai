...
const ACCEPTS_PROMPT = (t: string) => isValidTextToDialogueConnection("prompt", t, isVisualPicker)
...
function TextToDialogueNodeComponent({ id, data, selected }: NodeProps) {
  ...
  return (
    ...
    <HandleWithPopover nodeId={id} nodeType="text-to-dialogue" handleId="prompt" type="target" position={Position.Left}  label="Prompt" color="#ff0073" icon={<Type />}  side="left"  top="calc(100% - 24px)" accepts={ACCEPTS_PROMPT} />
    <HandleWithPopover nodeId={id} nodeType="text-to-dialogue" handleId="audio"  type="source" position={Position.Right} label="Audio"  color="#F59E0B" icon={<Users />} side="right" top="24px" />
