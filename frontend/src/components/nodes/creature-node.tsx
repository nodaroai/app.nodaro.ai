...
function CreatureNodeComponent({ id, data, selected }: NodeProps) {
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-1.5">
        ...
        {activeUrl && (
          <div className="relative group">
            <div className="w-full aspect-square rounded-md overflow-hidden bg-muted/30">
              ...
              <CachedImage
                src={activeUrl}
                alt={nodeData.creatureName || t("node.animalCreature")}
        ...
        <div className="grid grid-cols-5 gap-1 text-[9px]">
          ...
          <AssetBadge icon="🧍" label={t("node.assetBadgePoses")} count={counts.poses} status={nodeData.posesStatus ?? "idle"} />
        ...
        <AssetPickerNodeButton kind="creature" nodeId={id} currentDbId={nodeData.creatureDbId || null} />
    ...
    <HandleWithPopover nodeId={id} nodeType="creature" handleId="type"        type="target" position={Position.Left}  label={t("node.creatureType")} color={HANDLE_COLORS.imageRef} icon={<PawPrint />} side="left"  top="calc(100% - 56px)" accepts={ACCEPTS_TYPE} />
