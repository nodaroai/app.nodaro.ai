...
import { MapPin, Loader2, AlertCircle, X, ImageIcon, Maximize2, ChevronDown, ChevronRight, Type, Download, Link } from "lucide-react"
  ...
  return (
    ...
    <BaseNode
      ...
      handles={[
        ...
        { id: "locationRef", type: "source", position: Position.Right, customStyle: { top: '50%', right: '-29px' }, hideHandle: true },
      ]}
    >
    ...
    {/* Output handle icon */}
    <HandleIcon icon={<MapPin />} color="pink" side="right" top="50%" />
