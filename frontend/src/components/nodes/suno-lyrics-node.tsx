...
function SunoLyricsNodeComponent({ id, data, selected }: NodeProps) {
  ...
  return (
    ...
    <HandleWithPopover nodeId={id} nodeType="suno-lyrics" handleId="text"   type="source" position={Position.Right} label="Text"   color={TEXT_HANDLE_COLOR} icon={<FileText />} side="right" top="24px" />
