...
function SunoGenerateNodeComponent({ id, data, selected }: NodeProps) {
  ...
  return (
    ...
    <HandleWithPopover nodeId={id} nodeType="suno-generate" handleId="prompt"      type="target" position={Position.Left}  label="Prompt"      color="#ff0073" icon={<Type />}     side="left"  top="calc(100% - 24px)" accepts={ACCEPTS_PROMPT} />
    <HandleWithPopover nodeId={id} nodeType="suno-generate" handleId="audio-style" type="target" position={Position.Left}  label="Audio style" color="#F59E0B" icon={<Sparkles />} side="left"  top="calc(100% - 56px)" accepts={ACCEPTS_AUDIO_STYLE} />
    <HandleWithPopover nodeId={id} nodeType="suno-generate" handleId="voice"       type="target" position={Position.Left}  label="Voice"       color="#F59E0B" icon={<Mic />}      side="left"  top="calc(100% - 88px)" accepts={ACCEPTS_VOICE} />
    <HandleWithPopover nodeId={id} nodeType="suno-generate" handleId="audio"       type="source" position={Position.Right} label="Audio"       color="#F59E0B" icon={<Music />}    side="right" top="24px" />
