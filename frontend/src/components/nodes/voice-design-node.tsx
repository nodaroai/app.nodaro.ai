...
const ACCEPTS_PROMPT      = (t: string) => isValidVoiceDesignConnection("prompt",      t, isVisualPicker)
  ...
  return (
    ...
    <BaseNode
      ...
      handles={[
        ...
        { id: "voiceId", type: "source", position: Position.Right, customStyle: { top: '56px',              right: '-29px' }, external: true },
      ]}
    >
