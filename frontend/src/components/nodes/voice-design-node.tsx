...
import { Wand2, Loader2, AlertCircle, Volume2, Type, LayoutGrid, Copy, Check, Sparkles } from "lucide-react"
  ...
  return (
    ...
    <BaseNode
      ...
      handles={[
        ...
        { id: "voiceId", type: "source", position: Position.Right, customStyle: { top: '50px', right: '-29px' }, hideHandle: true },
      ]}
    >
