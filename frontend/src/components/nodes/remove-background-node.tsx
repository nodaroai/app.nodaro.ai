...
const ACCEPTS_IMAGE = (t: string) => isValidRemoveBackgroundConnection("image", t)

function RemoveBackgroundNodeComponent({ id, data, selected }: NodeProps) {
  const t = useT()
  const nodeData = data as RemoveBackgroundData
...
export const RemoveBackgroundNode = memo(RemoveBackgroundNodeComponent)
