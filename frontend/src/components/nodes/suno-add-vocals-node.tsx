...
function SunoAddVocalsNodeComponent({ id, data, selected }: NodeProps) {
  ...
  return (
    ...
    <div className="absolute pointer-events-none z-20 flex items-center justify-center w-7 h-7 rounded-full bg-[#ff0073] shadow-lg shadow-pink-500/30" style={{ top: '20px', right: '-29px', transform: 'translateY(-50%)' }}><Mic className="w-3.5 h-3.5 text-white" /></div>
