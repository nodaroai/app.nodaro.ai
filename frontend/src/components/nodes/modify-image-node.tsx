...
const ACCEPTS_MASK           = (t: string) => isValidModifyImageConnection("mask",           t, isPickerType)
const ACCEPTS_CINEMATOGRAPHY = (t: string) => isValidModifyImageConnection("cinematography", t, isPickerType)

function ModifyImageNodeComponent({ id, data, selected }: NodeProps) {
  const t = useT()
  const nodeData = data as ModifyImageData
...
export const ModifyImageNode = memo(ModifyImageNodeComponent)
