...
import { EXPOSURE_CATEGORY_LABELS, EXPOSURE_CATEGORY_ORDER, EXPOSURE_FIELD_BY_CATEGORY, getExposure, getExposureLabel, type ExposureCategory } from "@nodaro/prompts"
