...
import { Package, Loader2, AlertCircle, X, ImageIcon, Maximize2, ChevronDown, ChevronRight, Type, Download, Link } from "lucide-react"
  ...
  return (
    ...
    <BaseNode
      ...
      handles={[
        ...
        { id: "objectRef", type: "source", position: Position.Right, customStyle: { top: '50%', right: '-29px' }, hideHandle: true },
      ]}
    >
    ...
    {/* Output handle icon */}
    <HandleIcon icon={<Package />} color="pink" side="right" top="50%" />
