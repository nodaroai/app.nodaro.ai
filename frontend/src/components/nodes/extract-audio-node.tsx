...
// Extract Audio: video in (the "in" handle accepts video producers) → the
...
function ExtractAudioNodeComponent({ id, data, selected }: NodeProps) {
  ...
  return (
    ...
    <HandleWithPopover nodeId={id} nodeType="extract-audio" handleId="audio" type="source" position={Position.Right} label="Audio" color={FFMPEG_COLORS.audio} icon={<AudioLines />} side="right" top="24px" />
