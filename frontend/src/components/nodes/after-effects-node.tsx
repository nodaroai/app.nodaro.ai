...
function AfterEffectsNodeComponent({ id, data, selected }: NodeProps) {
  ...
  const credits = useModelCredits(buildLlmCreditIdentifier("after-effects", nodeData.llmModel || LLM_FEATURE_DEFAULTS["after-effects"], nodeData.reasoningEffort, nodeData.advancedMode === true), 10)
