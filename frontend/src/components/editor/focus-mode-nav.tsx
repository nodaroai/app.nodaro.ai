    ...
    <>
      ...
      {neighbors.up && (
        <button
          ...
          className="absolute top-[40%] left-1/2 -translate-x-1/2 z-40 w-10 h-10 flex items-center justify-center rounded-full bg-black/30 dark:bg-white/15 backdrop-blur-sm text-white active:bg-black/50 dark:active:bg-white/30 transition-colors touch-manipulation"
