  ...
  const panelContent = (
    <div className={isExpanded
      ...
      : isMobile
        ...
        : `absolute inset-0 z-10 bg-white dark:bg-[#1E1E1E] shadow-2xl flex flex-col sm:inset-auto sm:top-0 sm:right-0 sm:h-full sm:w-96 sm:border-l border-gray-200 dark:border-[#2D2D2D] transition-transform duration-200 ease-in-out ${isVisible && !isExpanded ? "translate-x-0" : "translate-x-full pointer-events-none"}`
    }>
      {isExpanded && (
