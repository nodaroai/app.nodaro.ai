...
export const RenderQualityPicker = memo(function RenderQualityPicker({
  value,
  onValueChange,
  className,
  ...
  return (
    <div className={cn("flex flex-col gap-3", className)}>
      <div className="relative">
        ...
        <Input
          aria-label="Search render quality"
          placeholder="Search render engine, quality stamp"
          value={query}
      ...
      {filtered.length === 0 && (
        <div className="text-xs text-muted-foreground text-center py-4">
          No render quality matches &quot;{query}&quot;
        </div>
      )}
