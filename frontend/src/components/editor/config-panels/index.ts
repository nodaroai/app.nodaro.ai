...
export { ImageToVideoConfig, VideoToVideoConfig, SwitchXConfig, MotionTransferConfig, VideoUpscaleConfig, TextToVideoConfig, GenerateVideoConfig, GenerateVideoProConfig, EditVideoProConfig, ExtendVideoConfig, SpeechToVideoConfig, FaceSwapConfig, VideoRetakeConfig, VideoAnalysisConfig } from "./video-configs"
