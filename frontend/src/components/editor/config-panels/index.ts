...
export { ImageToVideoConfig, VideoToVideoConfig, SwitchXConfig, MotionTransferConfig, VideoUpscaleConfig, TextToVideoConfig, GenerateVideoConfig, ExtendVideoConfig, SpeechToVideoConfig, FaceSwapConfig, VideoRetakeConfig } from "./video-configs"
