...
export { ImageToVideoConfig, VideoToVideoConfig, SwitchXConfig, MotionTransferConfig, VideoUpscaleConfig, TextToVideoConfig, GenerateVideoConfig, ExtendVideoConfig, SpeechToVideoConfig, FaceSwapConfig, VideoRetakeConfig, VideoAnalysisConfig } from "./video-configs"
