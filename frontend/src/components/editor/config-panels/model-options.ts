...
export const VIDEO_I2V_MODELS = [
  ...
  { value: "seedance-2-5", label: "Seedance 2.5", desc: "Bytedance latest, up to 30s in one shot, wide multimodal refs, 480p/720p" },
...
export const LIP_SYNC_MODELS: readonly { value: LipSyncProvider; label: string; desc: string }[] = [
  ...
  { value: "seedance-2-5", label: "Seedance 2.5", desc: "Same lip sync, latest generation, up to 30s, 480p/720p" },
