...
export const FIELD_COMPATIBLE_TYPES: Readonly<Record<string, ReadonlyArray<string>>> = {
  ...
  voiceDescription: ["text-prompt"],
  genre: ["text-prompt"],
  mood: ["text-prompt"],
  caption: ["text-prompt"],
  transcript: ["text-prompt"],
  directText: ["text-prompt"],
  characterName: ["text-prompt"],
  faceName: ["text-prompt"],
  objectName: ["text-prompt"],
  locationName: ["text-prompt"],
  baseOutfit: ["text-prompt"],
