 ...
 * Approve/Discard per card, and the canonical description display. Split out of
 * the old `appearance-tab.tsx`; the reference-photo mood-board now lives on the
 * References page (Resources group). Behavior is otherwise byte-identical,
 * including the object-specific deltas:
 *  - UpstreamPickerBanner rendered when `stagedData.legacyPickerSelection` is
 *    non-null (E1 breadcrumb); dismiss sets it to null.
        ...
        <section>
          ...
          {data.sourceImageUrl ? (
            <img
              ...
              alt={data.objectName || t("field.object")}
              loading="lazy"
        ...
        <section className="space-y-3">
          ...
          <label className="block">
            ...
            <input
              ...
              placeholder={t("studio.objectNamePh")}
          ...
          <label className="block">
            ...
            <textarea
              ...
              placeholder={t("studio.objectDescriptionPh")}
              rows={3}
        ...
        <section>
          ...
          {cands.tracked.length > 0 && (
            <div className="mt-2 text-[10px] text-slate-500">
              {cands.tracked.length === 1
                ? t("studio.generatingCandidatesOne", { n: 1 })
                : t("studio.generatingCandidatesMany", { n: cands.tracked.length })}
            </div>
          )}
        </section>
