...
/**
 * Board page — read-only display of the object's named composite reference
 ...
 */
export function BoardPage({ state }: StudioPageProps<ObjectStudioState, ObjectStudioJobs>) {
